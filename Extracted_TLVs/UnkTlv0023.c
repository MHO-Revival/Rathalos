...
// ============================================================
// Name: TLV::UnkTlv0023::DoDebugFormat
// Address Name: SUB_10120030
// ============================================================
//----- (10120030) --------------------------------------------------------
int __thiscall sub_10120030(void *this, signed __int32 a2, int a3, _DWORD *a4, int a5, int a6)
{
  int v7; // esi
  ...
  v10 = a3;
  v12 = 0;
  v7 = sub_101200E0((int)this, &v8, a5, a6);
  if ( a4 )
    *a4 = v9;
  if ( v11 )
    sub_10C3DA30(v8);
...
// ============================================================
// Name: TLV::UnkTlv0023::DebugFormat
