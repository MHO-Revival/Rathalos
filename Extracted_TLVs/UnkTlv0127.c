// ============================================================
// Name: TLV::UnkTlv0127::Read_0xAA
// Address Name: SUB_10174ED0
// ============================================================
//----- (10174ED0) --------------------------------------------------------
int __thiscall sub_10174ED0(int *this, _DWORD *a2, int a3)
{
  int v3; // eax
  int v5; // ecx
  _DWORD *v6; // edi
...
// ============================================================
// Name: TLV::UnkTlv0127::Read_0x99
// Address Name: SUB_10175020
// ============================================================
//----- (10175020) --------------------------------------------------------
int __thiscall sub_10175020(_DWORD *this, _DWORD *a2, int a3)
{
  int v3; // eax
  int v5; // ecx
  _DWORD *v6; // edi
...
// ============================================================
// Name: TLV::UnkTlv0127::DoDebugFormat
// Address Name: SUB_10175190
// ============================================================
//----- (10175190) --------------------------------------------------------
int __stdcall sub_10175190(signed __int32 a1, int a2, _DWORD *a3, int a4, int a5)
{
  int v6; // esi
  signed __int32 v7; // [esp+8h] [ebp-1Ch] BYREF
...
// 10175240: using guessed type _DWORD __stdcall sub_10175240(_DWORD, _DWORD, _DWORD);



// ============================================================
// Name: TLV::UnkTlv0127::DebugFormat
// Address Name: SUB_10175240
// ============================================================
//----- (10175240) --------------------------------------------------------
int __thiscall sub_10175240(int *this, _DWORD *a2, int a3, char a4)
{
  int result; // eax
  int v6; // ecx
  int v7; // eax
  ...
  if ( !result )
  {
    ...
    if ( *this >= 0 )
    {
      if ( v7 <= 200 )
      {
        result = sub_1024A3B0(a2, a3, v6, "[ctxs]", v7);
        if ( !result )
        {
          v8 = 0;
          if ( *this <= 0 )
...
// 1017529D: variable 'v6' is possibly undefined
