...
// ============================================================
// Name: TLV::UnkTlv0015::DoDebugFormat
// Address Name: SUB_1011A320
// ============================================================
//----- (1011A320) --------------------------------------------------------
int __thiscall sub_1011A320(char *this, int a2, int a3, _DWORD *a4, int a5, char a6)
{
  int v8; // edi
  ...
  v11 = a3;
  v13 = 0;
  v8 = print_field(&v9, a5, a6, "[commerceId]", "%u", *(_DWORD *)this);
  if ( !v8 )
    v8 = print_field(&v9, a5, a6, "[ownGuildId]", "%I64u", *(_QWORD *)(this + 4));
  if ( a4 )
    *a4 = v10;
  if ( v12 )
    sub_10C3DA30(v9);
