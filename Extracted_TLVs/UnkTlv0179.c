...
// ============================================================
// Name: TLV::UnkTlv0179::DoDebugFormat
// Address Name: SUB_101A0E40
// ============================================================
//----- (101A0E40) --------------------------------------------------------
int __thiscall sub_101A0E40(_DWORD *this, int a2, int a3, _DWORD *a4, int a5, char a6)
{
  int v8; // esi
  ...
  if ( !v8 )
    v8 = print_field(&v9, a5, a6, "[slot]", "%d", *(this + 1));
  if ( a4 )
    *a4 = v10;
  if ( v12 )
    sub_10C3DA30(v9);
