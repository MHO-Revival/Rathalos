...
// ============================================================
// Name: TLV::UnkTlv0022::DoDebugFormat
// Address Name: SUB_1011F6B0
// ============================================================
//----- (1011F6B0) --------------------------------------------------------
int __thiscall sub_1011F6B0(_DWORD *this, signed __int32 a2, int a3, _DWORD *a4, int a5, int a6)
{
  int v7; // esi
...
// ============================================================
// Name: TLV::UnkTlv0022::DebugFormat
