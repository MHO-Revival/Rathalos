// ============================================================
// Name: TLV::UnkTlv0058::Read
// Address Name: SUB_1013EC30
// ============================================================
//----- (1013EC30) --------------------------------------------------------
int __thiscall sub_1013EC30(void *this, size_t a2, unsigned int a3, _DWORD *a4)
{
  int result; // eax
  size_t v6; // esi
  char v7; // bl
  ...
  v8 = a2 - 5;
  if ( v7 == -86 )
    result = sub_1013ED00((int)this, (size_t)&Size, v8);
  else
    result = sub_1013F1D0((int)this, (size_t)&Size, v8);
  if ( a4 )
    *a4 = v10;
  return result;
}
...
// ============================================================
// Name: TLV::UnkTlv0058::DoDebugFormat
// Address Name: SUB_1013F6C0
// ============================================================
//----- (1013F6C0) --------------------------------------------------------
int __thiscall sub_1013F6C0(unsigned __int8 *this, signed __int32 a2, int a3, _DWORD *a4, int a5, char a6)
{
  int v7; // esi
...
// ============================================================
// Name: TLV::UnkTlv0058::DebugFormat
