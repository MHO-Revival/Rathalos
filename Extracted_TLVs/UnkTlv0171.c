// ============================================================
// Name: TLV::UnkTlv0171::Read
// Address Name: SUB_1019B4E0
// ============================================================
//----- (1019B4E0) --------------------------------------------------------
int __thiscall sub_1019B4E0(_DWORD *this, unsigned int a2, unsigned int a3, _DWORD *a4)
{
  int result; // eax
  unsigned int v6; // esi
  char v7; // bl
  ...
  v8 = a2 - 5;
  if ( v7 == -86 )
    result = sub_1019B5B0(this, &v9, v8);
  else
    result = sub_1019B6C0((int)this, &v9, v8);
  if ( a4 )
    *a4 = v10;
  return result;
}
...
// ============================================================
// Name: TLV::UnkTlv0171::Read_0xAA
// Address Name: SUB_1019B5B0
// ============================================================
//----- (1019B5B0) --------------------------------------------------------
int __thiscall sub_1019B5B0(_DWORD *this, _DWORD *a2, int a3)
{
  int v4; // esi
  unsigned int v5; // eax
  int result; // eax
...
LABEL_16:
    ...
    else
    {
      ...
      if ( (*(_DWORD *)((char *)this + 178) & 2) == 0 )
        *(_DWORD *)((char *)this + 178) |= 2u;
      v9 = 0;
      v4 = TdrBuf::ReadInt32(a2, &v9);
      if ( v4 )
        return v4;
      if ( v9 )
      {
        v7 = sub_10215740((int)(this + 12), a2, v9);
        goto LABEL_16;
      }
    }
  }
...
// ============================================================
// Name: TLV::UnkTlv0171::Read_0x99
// Address Name: SUB_1019B6C0
// ============================================================
//----- (1019B6C0) --------------------------------------------------------
int __thiscall sub_1019B6C0(int this, _DWORD *a2, int a3)
{
  int v4; // esi
  unsigned int v5; // eax
  int result; // eax
...
// ============================================================
// Name: TLV::UnkTlv0171::DoDebugFormat
// Address Name: SUB_1019B7F0
// ============================================================
//----- (1019B7F0) --------------------------------------------------------
int __thiscall sub_1019B7F0(float *this, signed __int32 a2, int a3, _DWORD *a4, int a5, int a6)
{
  int v7; // esi
...
// ============================================================
// Name: TLV::UnkTlv0171::DebugFormat
// Address Name: SUB_1019B8A0
// ============================================================
//----- (1019B8A0) --------------------------------------------------------
int __thiscall sub_1019B8A0(float *this, _DWORD *a2, int a3, int a4)
{
  int result; // eax
  ...
  if ( !result )
  {
    result = Printf(a2, "%s%c", "[saveMap]", (char)a4);
    if ( !result )
    {
      if ( a3 >= 0 )
        result = sub_10165A70(this, a2, a3 + 1, a4);
      else
        result = sub_10165A70(this, a2, a3, a4);
      if ( !result )
      {
        result = print_structure((int)a2, a3, a4, (int)"[starLevel]");
        if ( !result )
        {
          v5 = (unsigned __int8 *)(this + 12);
          if ( a3 >= 0 )
            return sub_10215C50(v5, a2, a3 + 1, a4);
          else
            return sub_10215C50(v5, a2, a3, a4);
        }
      }
    }
  }
