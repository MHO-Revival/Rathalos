...
// ============================================================
// Name: TLV::UnkTlv0235::DoDebugFormat
// Address Name: SUB_10216DA0
// ============================================================
//----- (10216DA0) --------------------------------------------------------
int __thiscall sub_10216DA0(unsigned __int8 *this, int a2, int a3, _DWORD *a4, int a5, char a6)
{
  int v8; // esi
  ...
  v11 = a3;
  v13 = 0;
  v8 = print_field(&v9, a5, a6, "[quality]", "0x%02x", *this);
  if ( !v8 )
