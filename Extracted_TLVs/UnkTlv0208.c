// ============================================================
// Name: TLV::UnkTlv0208::Read
// Address Name: SUB_101FD2D0
// ============================================================
//----- (101FD2D0) --------------------------------------------------------
int __thiscall sub_101FD2D0(void *this, unsigned int a2, unsigned int a3, _DWORD *a4)
{
  int result; // eax
  unsigned int v6; // esi
  char v7; // bl
  ...
  v8 = a2 - 5;
  if ( v7 == -86 )
    result = sub_101FD3A0((int)this, &v9, v8);
  else
    result = sub_101FD540((int)this, &v9, v8);
  if ( a4 )
    *a4 = v10;
  return result;
}
...
// ============================================================
// Name: TLV::UnkTlv0208::Read_0xAA
// Address Name: SUB_101FD3A0
// ============================================================
//----- (101FD3A0) --------------------------------------------------------
int __thiscall sub_101FD3A0(int this, _DWORD *a2, int a3)
{
  int result; // eax
  unsigned int v5; // ecx
  __int16 v6; // si
...
LABEL_28:
  ...
  else
  {
    while ( 1 )
    {
      ...
      {
        case 1u:
          if ( (*(_BYTE *)(this + 10890) & 1) == 0 )
            *(_DWORD *)(this + 10890) |= 1u;
          result = TdrBuf::ReadVarULong(a2, (_DWORD *)this);
          break;
        case 2u:
          if ( (*(_DWORD *)(this + 10890) & 2) == 0 )
            *(_DWORD *)(this + 10890) |= 2u;
          result = TdrBuf::ReadVarShort(a2, (_WORD *)(this + 8));
          break;
        case 3u:
          if ( (*(_DWORD *)(this + 10890) & 4) == 0 )
            *(_DWORD *)(this + 10890) |= 4u;
          v8 = 0;
          ...
          if ( !result )
          {
            if ( v8 )
            {
              ...
              while ( 1 )
              {
                ...
                if ( v10 )
                {
                  result = sub_101FC550((int *)(272 * v6 + this + 10), a2, v10);
                  if ( result )
                    break;
                }
                v7 = a2[1];
...
// ============================================================
// Name: TLV::UnkTlv0208::Read_0x99
// Address Name: SUB_101FD540
// ============================================================
//----- (101FD540) --------------------------------------------------------
int __thiscall sub_101FD540(int this, _DWORD *a2, int a3)
{
  int result; // eax
  unsigned int v5; // ecx
  __int16 v6; // si
    ...
    while ( 1 )
    {
      ...
      switch ( v9 >> 4 )
      {
        case 1u:
          if ( (*(_BYTE *)(this + 10890) & 1) == 0 )
            *(_DWORD *)(this + 10890) |= 1u;
          result = TdrBuf::ReadInt64(a2, (_BYTE *)this);
          break;
        case 2u:
          if ( (*(_DWORD *)(this + 10890) & 2) == 0 )
            *(_DWORD *)(this + 10890) |= 2u;
          result = TdrBuf::ReadInt16(a2, (_BYTE *)(this + 8));
          break;
        case 3u:
          if ( (*(_DWORD *)(this + 10890) & 4) == 0 )
            *(_DWORD *)(this + 10890) |= 4u;
          ...
          if ( !result )
          {
            if ( v8 )
            {
              ...
              while ( 1 )
              {
                ...
                if ( v10 )
                {
                  result = sub_101FC830((_DWORD *)(272 * v6 + this + 10), a2, v10);
                  if ( result )
                    break;
                }
                v7 = a2[1];
...
// ============================================================
// Name: TLV::UnkTlv0208::DoDebugFormat
// Address Name: SUB_101FD700
// ============================================================
//----- (101FD700) --------------------------------------------------------
int __thiscall sub_101FD700(__int16 *this, signed __int32 a2, int a3, _DWORD *a4, int a5, char a6)
{
  int v7; // esi
...
// ============================================================
// Name: TLV::UnkTlv0208::DebugFormat
// Address Name: SUB_101FD7B0
// ============================================================
//----- (101FD7B0) --------------------------------------------------------
int __thiscall sub_101FD7B0(__int16 *this, _DWORD *a2, int a3, char a4)
{
  int result; // eax
  __int16 v6; // ax
  __int16 v7; // si
  ...
  if ( !result )
  {
    result = print_field(a2, a3, a4, "[count]", "%d", *(this + 4));
    if ( !result )
    {
      v6 = *(this + 4);
      if ( v6 >= 0 )
          ...
          else
          {
            while ( 1 )
            {
              ...
              if ( result )
                break;
              v8 = this + 136 * v7 + 5;
              result = a3 >= 0 ? sub_101FCBE0(v8, a2, a3 + 1, a4) : sub_101FCBE0(v8, a2, a3, a4);
              if ( result )
                break;
              if ( ++v7 >= *(this + 4) )
                return 0;
