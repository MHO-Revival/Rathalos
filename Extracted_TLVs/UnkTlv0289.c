// ============================================================
// Name: TLV::UnkTlv0289::Read_0xAA
// Address Name: SUB_10244CF0
// ============================================================
//----- (10244CF0) --------------------------------------------------------
int __thiscall sub_10244CF0(int *this, _DWORD *a2, int a3)
{
  int v3; // eax
  int *v4; // ebx
  int v5; // esi
...
// ============================================================
// Name: TLV::UnkTlv0289::Read_0x99
// Address Name: SUB_10244E60
// ============================================================
//----- (10244E60) --------------------------------------------------------
int __thiscall sub_10244E60(_DWORD *this, _DWORD *a2, int a3)
{
  int v3; // eax
  _DWORD *v4; // ebx
  int v5; // esi
...
// ============================================================
// Name: TLV::UnkTlv0289::DoDebugFormat
// Address Name: SUB_10244FF0
// ============================================================
//----- (10244FF0) --------------------------------------------------------
int __thiscall sub_10244FF0(int *this, signed __int32 a2, int a3, _DWORD *a4, int a5, char a6)
{
  int v7; // esi
...
// ============================================================
// Name: TLV::UnkTlv0289::DebugFormat
// Address Name: SUB_102450A0
// ============================================================
//----- (102450A0) --------------------------------------------------------
int __thiscall sub_102450A0(int *this, _DWORD *a2, int a3, char a4)
{
  int result; // eax
  int v6; // eax
  int v7; // esi
      ...
      if ( v6 <= 1024 )
      {
        ...
        else
        {
          for ( i = this + 1; ; i = (_DWORD *)((char *)i + 13) )
          {
            ...
            if ( result )
              break;
            result = Printf(a2, "%s[%u]%c", "[state]", v7, a4);
            if ( result )
              break;
            result = a3 >= 0 ? sub_10244790(i, a2, a3 + 1, a4) : sub_10244790(i, a2, a3, a4);
            if ( result )
              break;
            if ( ++v7 >= *this )
              return 0;
...
// Address Name: SUB_102444C0
// ============================================================
//----- (102444C0) --------------------------------------------------------
int __thiscall sub_102444C0(int this, _DWORD *a2, int a3)
{
  int v4; // ecx
  unsigned int v5; // ebx
  int result; // eax
...
// ============================================================
// Name: Internal Helper Function
// Address Name: SUB_102445C0
// ============================================================
//----- (102445C0) --------------------------------------------------------
int __thiscall sub_102445C0(int this, _DWORD *a2, int a3)
{
  int v4; // ecx
  unsigned int v5; // ebx
  int result; // eax
...
// ============================================================
// Name: Internal Helper Function
// Address Name: SUB_10244790
// ============================================================
//----- (10244790) --------------------------------------------------------
int __thiscall sub_10244790(_DWORD *this, _DWORD *a2, int a3, char a4)
{
  int result; // eax
  ...
  if ( !result )
  {
    result = print_field(a2, a3, a4, "[state]", "0x%02x", *((unsigned __int8 *)this + 4));
    if ( !result )
      return print_field(a2, a3, a4, "[lastUpdate]", "%u", *(_DWORD *)((char *)this + 5));
  }
  return result;
}
