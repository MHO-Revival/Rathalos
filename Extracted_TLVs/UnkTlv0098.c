// ============================================================
// Name: TLV::UnkTlv0098::Read
// Address Name: SUB_1015EF40
// ============================================================
//----- (1015EF40) --------------------------------------------------------
int __thiscall sub_1015EF40(int *this, unsigned int a2, unsigned int a3, _DWORD *a4)
{
  int result; // eax
  unsigned int v6; // esi
  char v7; // bl
  ...
  v8 = a2 - 5;
  if ( v7 == -86 )
    result = sub_1015F010(this, &v9, v8);
  else
    result = sub_1015F270((int)this, &v9, v8);
  if ( a4 )
    *a4 = v10;
  return result;
}
...
// ============================================================
// Name: TLV::UnkTlv0098::DoDebugFormat
// Address Name: SUB_1015F4F0
// ============================================================
//----- (1015F4F0) --------------------------------------------------------
int __thiscall sub_1015F4F0(_DWORD *this, signed __int32 a2, int a3, _DWORD *a4, int a5, char a6)
{
  int v7; // esi
...
// ============================================================
// Name: TLV::UnkTlv0098::DebugFormat
