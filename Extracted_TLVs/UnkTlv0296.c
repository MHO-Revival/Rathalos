...
// ============================================================
// Name: TLV::UnkTlv0296::DoDebugFormat
// Address Name: SUB_1024B1A0
// ============================================================
//----- (1024B1A0) --------------------------------------------------------
int __thiscall sub_1024B1A0(unsigned __int8 *this, int a2, int a3, _DWORD *a4, int a5, char a6)
{
  int v8; // esi
  ...
  v11 = a3;
  v13 = 0;
  v8 = print_field(&v9, a5, a6, "[giftId]", "%d", *(_DWORD *)this);
  if ( !v8 )
    v8 = print_field(&v9, a5, a6, "[giftState]", "0x%02x", *(this + 4));
  if ( a4 )
    *a4 = v10;
  if ( v12 )
    sub_10C3DA30(v9);
