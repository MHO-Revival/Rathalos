...
// ============================================================
// Name: TLV::UnkTlv0055::DoDebugFormat
// Address Name: SUB_1013C6B0
// ============================================================
//----- (1013C6B0) --------------------------------------------------------
int __thiscall sub_1013C6B0(unsigned int *this, signed __int32 a2, int a3, _DWORD *a4, int a5, char a6)
{
  int v7; // esi
...
// ============================================================
// Name: TLV::UnkTlv0055::DebugFormat
