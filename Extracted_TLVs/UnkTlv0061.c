// ============================================================
// Name: TLV::UnkTlv0061::Read_0xAA
// Address Name: SUB_101418A0
// ============================================================
//----- (101418A0) --------------------------------------------------------
int __thiscall sub_101418A0(int *this, int *Size, unsigned int a3)
{
  unsigned int v3; // eax
  int *v4; // edi
  int v6; // esi
...
// ============================================================
// Name: TLV::UnkTlv0061::Read_0x99
// Address Name: SUB_10141950
// ============================================================
//----- (10141950) --------------------------------------------------------
int __thiscall sub_10141950(_DWORD *this, _DWORD *Size, unsigned int a3)
{
  unsigned int v3; // eax
  _DWORD *v4; // edi
  int v6; // esi
...
// ============================================================
// Name: TLV::UnkTlv0061::DoDebugFormat
// Address Name: SUB_10141A20
// ============================================================
//----- (10141A20) --------------------------------------------------------
int __thiscall sub_10141A20(int *this, signed __int32 a2, int a3, _DWORD *a4, int a5, int a6)
{
  int v7; // esi
...
// ============================================================
// Name: TLV::UnkTlv0061::DebugFormat
// Address Name: SUB_10141AD0
// ============================================================
//----- (10141AD0) --------------------------------------------------------
int __thiscall sub_10141AD0(int *this, _DWORD *a2, int a3, int a4)
{
  int result; // eax
  ...
  if ( !result )
  {
    result = Printf(a2, "%s%c", "[libs]", (char)a4);
    if ( !result )
    {
      if ( a3 >= 0 )
        return sub_101412A0(this, a2, a3 + 1, a4);
      else
        return sub_101412A0(this, a2, a3, a4);
    }
  }
  return result;
}
