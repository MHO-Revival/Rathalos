...
// ============================================================
// Name: TLV::UnkTlv0150::DoDebugFormat
// Address Name: SUB_10185460
// ============================================================
//----- (10185460) --------------------------------------------------------
int __thiscall sub_10185460(_DWORD *this, int a2, int a3, _DWORD *a4, int a5, char a6)
{
  int v8; // esi
  ...
  v11 = a3;
  v13 = 0;
  v8 = print_field(&v9, a5, a6, "[itemID]", "%d", *this);
  if ( !v8 )
    v8 = print_field(&v9, a5, a6, "[enchanseCount]", "%u", *(this + 1));
  if ( a4 )
    *a4 = v10;
  if ( v12 )
    sub_10C3DA30(v9);
