// ============================================================
// Name: TLV::UnkTlv0121::Read
// Address Name: SUB_10170F60
// ============================================================
//----- (10170F60) --------------------------------------------------------
int __thiscall sub_10170F60(int *this, unsigned int a2, unsigned int a3, _DWORD *a4)
{
  int result; // eax
  unsigned int v6; // esi
  char v7; // bl
  ...
  v8 = a2 - 5;
  if ( v7 == -86 )
    result = sub_10171030(this, &v9, v8);
  else
    result = sub_101710F0((int)this, &v9, v8);
  if ( a4 )
    *a4 = v10;
  return result;
}
...
// ============================================================
// Name: TLV::UnkTlv0121::DoDebugFormat
// Address Name: SUB_101711C0
// ============================================================
//----- (101711C0) --------------------------------------------------------
int __thiscall sub_101711C0(_DWORD *this, signed __int32 a2, int a3, _DWORD *a4, int a5, char a6)
{
  int v7; // esi
...
// ============================================================
// Name: TLV::UnkTlv0121::DebugFormat
