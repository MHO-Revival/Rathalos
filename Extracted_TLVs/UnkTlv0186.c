// ============================================================
// Name: TLV::UnkTlv0186::Read
// Address Name: SUB_101A6DF0
// ============================================================
//----- (101A6DF0) --------------------------------------------------------
int __thiscall sub_101A6DF0(void *this, size_t a2, unsigned int a3, _DWORD *a4)
{
  int result; // eax
  size_t v6; // esi
  char v7; // bl
  ...
  v8 = a2 - 5;
  if ( v7 == -86 )
    result = sub_101A6EC0((int)this, &Size, v8);
  else
    result = sub_101A7300((int)this, &Size, v8);
  if ( a4 )
    *a4 = v10;
  return result;
}
...
// ============================================================
// Name: TLV::UnkTlv0186::Read_0xAA
// Address Name: SUB_101A6EC0
// ============================================================
//----- (101A6EC0) --------------------------------------------------------
int __thiscall sub_101A6EC0(int this, _DWORD *Size, int a3)
{
  int v3; // ebx
  int Byte; // esi
  unsigned int v5; // eax
  ...
  unsigned int v19; // [esp+18h] [ebp-10h] BYREF
  ...
  *(_DWORD *)(this + 15465) = 0;
  ...
  while ( 2 )
  {
    result = TdrBuf::ReadVarUInt(Size, &v19);
    if ( result )
      return result;
    switch ( v19 >> 4 )
    {
      case 2u:
        if ( (*(_BYTE *)(v3 + 15465) & 1) == 0 )
          *(_DWORD *)(v3 + 15465) |= 1u;
        VarInt = sub_10115A30(Size, (_BYTE *)v3);
        goto LABEL_64;
      case 3u:
        if ( (*(_DWORD *)(v3 + 15465) & 2) == 0 )
          *(_DWORD *)(v3 + 15465) |= 2u;
        VarInt = TdrBuf::ReadVarInt(Size, (int *)(v3 + 1));
        goto LABEL_64;
      case 4u:
        if ( (*(_DWORD *)(v3 + 15465) & 4) == 0 )
          *(_DWORD *)(v3 + 15465) |= 4u;
        VarInt = sub_10115A30(Size, (_BYTE *)(v3 + 5));
        goto LABEL_64;
      case 5u:
        if ( (*(_DWORD *)(v3 + 15465) & 8) == 0 )
          *(_DWORD *)(v3 + 15465) |= 8u;
        v17 = 0;
        result = TdrBuf::ReadInt32(Size, &v17);
        if ( result )
          return result;
        if ( !v17 )
          return -37;
        ...
        {
          v20 = 0;
          Byte = TdrBuf::ReadInt32(Size, &v20);
          if ( Byte )
            return Byte;
          if ( v20 )
          {
            Byte = sub_101A4CC0(v18, (size_t)Size, v20);
            if ( Byte )
              return Byte;
          }
          v9 = Size[1];
        ...
        *(_BYTE *)(this + 5) = v8 + 1;
        ...
        goto LABEL_65;
      case 6u:
        if ( (*(_DWORD *)(v3 + 15465) & 0x10) == 0 )
          *(_DWORD *)(v3 + 15465) |= 0x10u;
        VarInt = sub_10115A30(Size, (_BYTE *)(v3 + 15318));
        goto LABEL_64;
      case 7u:
        if ( (*(_DWORD *)(v3 + 15465) & 0x20) == 0 )
          *(_DWORD *)(v3 + 15465) |= 0x20u;
        VarInt = TdrBuf::ReadVarShort(Size, (_WORD *)(v3 + 15319));
        goto LABEL_64;
      case 8u:
        if ( (*(_DWORD *)(v3 + 15465) & 0x40) == 0 )
          *(_DWORD *)(v3 + 15465) |= 0x40u;
        v18 = 0;
        result = TdrBuf::ReadInt32(Size, &v18);
        if ( result )
          return result;
        if ( !v18 )
          return -37;
        ...
        while ( 1 )
        {
          Byte = TdrBuf::ReadByte(Size, (_BYTE *)(this + 15321 + v10));
          if ( Byte )
            return Byte;
          v11 = Size[1];
          if ( v11 > v21 + v18 )
        ...
        v12 = v10 + 1;
        v3 = this;
        *(_WORD *)(this + 15319) = v12;
        goto LABEL_65;
      case 9u:
        if ( (*(_DWORD *)(v3 + 15465) & 0x80) == 0 )
          *(_DWORD *)(v3 + 15465) |= 0x80u;
        VarInt = TdrBuf::ReadVarShort(Size, (_WORD *)(v3 + 15391));
        goto LABEL_64;
      case 0xAu:
        if ( (*(_DWORD *)(v3 + 15465) & 0x100) == 0 )
          *(_DWORD *)(v3 + 15465) |= 0x100u;
        v18 = 0;
        result = TdrBuf::ReadInt32(Size, &v18);
        if ( result )
          return result;
        ...
        while ( 1 )
        {
          Byte = TdrBuf::ReadByte(Size, (_BYTE *)(this + 15393 + v13));
          if ( Byte )
            return Byte;
          v14 = Size[1];
          if ( v14 > v21 + v18 )
...
LABEL_66:
        ...
        return Byte;
      case 0xBu:
        if ( (*(_DWORD *)(v3 + 15465) & 0x200) == 0 )
          *(_DWORD *)(v3 + 15465) |= 0x200u;
        VarInt = sub_10115A30(Size, (_BYTE *)(v3 + 15463));
        goto LABEL_64;
      case 0xCu:
        if ( (*(_DWORD *)(v3 + 15465) & 0x400) == 0 )
          *(_DWORD *)(v3 + 15465) |= 0x400u;
        VarInt = sub_10115A30(Size, (_BYTE *)(v3 + 15464));
        goto LABEL_64;
      default:
        VarInt = TdrBuf::SkipField(Size, v19 & 0xF);
LABEL_64:
        Byte = VarInt;
        if ( !VarInt )
          goto LABEL_65;
...
// ============================================================
// Name: TLV::UnkTlv0186::Read_0x99
// Address Name: SUB_101A7300
// ============================================================
//----- (101A7300) --------------------------------------------------------
int __thiscall sub_101A7300(int this, _DWORD *Size, int a3)
{
  int v3; // ebx
  int Byte; // esi
  unsigned int v5; // eax
  ...
  while ( 2 )
  {
    ...
    switch ( v19 >> 4 )
    {
      case 2u:
        if ( (*(_BYTE *)(v3 + 15465) & 1) == 0 )
          *(_DWORD *)(v3 + 15465) |= 1u;
        Int32 = sub_10115A30(Size, (_BYTE *)v3);
        goto LABEL_64;
      case 3u:
        if ( (*(_DWORD *)(v3 + 15465) & 2) == 0 )
          *(_DWORD *)(v3 + 15465) |= 2u;
        Int32 = TdrBuf::ReadInt32(Size, (_BYTE *)(v3 + 1));
        goto LABEL_64;
      case 4u:
        if ( (*(_DWORD *)(v3 + 15465) & 4) == 0 )
          *(_DWORD *)(v3 + 15465) |= 4u;
        Int32 = sub_10115A30(Size, (_BYTE *)(v3 + 5));
        goto LABEL_64;
      case 5u:
        if ( (*(_DWORD *)(v3 + 15465) & 8) == 0 )
          *(_DWORD *)(v3 + 15465) |= 8u;
        ...
        while ( 1 )
        {
          ...
          if ( v20 )
          {
            Byte = sub_101A54E0(v18, (size_t)Size, v20);
            if ( Byte )
              return Byte;
          }
          v9 = Size[1];
      ...
      case 6u:
        if ( (*(_DWORD *)(v3 + 15465) & 0x10) == 0 )
          *(_DWORD *)(v3 + 15465) |= 0x10u;
        Int32 = sub_10115A30(Size, (_BYTE *)(v3 + 15318));
        goto LABEL_64;
      case 7u:
        if ( (*(_DWORD *)(v3 + 15465) & 0x20) == 0 )
          *(_DWORD *)(v3 + 15465) |= 0x20u;
        Int32 = TdrBuf::ReadInt16(Size, (_BYTE *)(v3 + 15319));
        goto LABEL_64;
      case 8u:
        if ( (*(_DWORD *)(v3 + 15465) & 0x40) == 0 )
          *(_DWORD *)(v3 + 15465) |= 0x40u;
      ...
      case 9u:
        if ( (*(_DWORD *)(v3 + 15465) & 0x80) == 0 )
          *(_DWORD *)(v3 + 15465) |= 0x80u;
        Int32 = TdrBuf::ReadInt16(Size, (_BYTE *)(v3 + 15391));
        goto LABEL_64;
      case 0xAu:
        if ( (*(_DWORD *)(v3 + 15465) & 0x100) == 0 )
          *(_DWORD *)(v3 + 15465) |= 0x100u;
...
LABEL_66:
      ...
      case 0xBu:
        if ( (*(_DWORD *)(v3 + 15465) & 0x200) == 0 )
          *(_DWORD *)(v3 + 15465) |= 0x200u;
        Int32 = sub_10115A30(Size, (_BYTE *)(v3 + 15463));
        goto LABEL_64;
      case 0xCu:
        if ( (*(_DWORD *)(v3 + 15465) & 0x400) == 0 )
          *(_DWORD *)(v3 + 15465) |= 0x400u;
        Int32 = sub_10115A30(Size, (_BYTE *)(v3 + 15464));
        goto LABEL_64;
      default:
        Int32 = TdrBuf::SkipField(Size, v19 & 0xF);
LABEL_64:
        Byte = Int32;
        if ( !Int32 )
          goto LABEL_65;
...
// ============================================================
// Name: TLV::UnkTlv0186::DoDebugFormat
// Address Name: SUB_101A7760
// ============================================================
//----- (101A7760) --------------------------------------------------------
int __thiscall sub_101A7760(char *this, signed __int32 a2, int a3, _DWORD *a4, int a5, int a6)
{
  int v7; // esi
...
// ============================================================
// Name: TLV::UnkTlv0186::DebugFormat
// Address Name: SUB_101A7810
// ============================================================
//----- (101A7810) --------------------------------------------------------
int __thiscall sub_101A7810(char *this, _DWORD *a2, int a3, int a4)
{
  int result; // eax
  char v8; // al
  int v9; // ecx
  ...
  result = print_field(a2, a3, a4, "[unlock]", "0x%02x", *this);
  if ( result )
    return result;
  result = print_field(a2, a3, a4, "[iD]", "%d", *(_DWORD *)(this + 1));
  if ( result )
    return result;
  result = print_field(a2, a3, a4, "[count]", "0x%02x", *(this + 5));
  if ( result )
    return result;
  v8 = *(this + 5);
  if ( v8 < 0 )
  ...
  {
LABEL_16:
    result = print_field(a2, a3, a4, "[ownedNumMax]", "0x%02x", *(this + 15318));
    if ( result )
      return result;
    result = print_field(a2, a3, a4, "[battleNum]", "%d", *(__int16 *)(this + 15319));
    if ( result )
      return result;
    v10 = *(_WORD *)(this + 15319);
    if ( v10 < 0 )
      return -6;
    if ( v10 <= 70 )
    {
      result = sub_1024A3B0(a2, a3, 70, "[battle]", v10);
      if ( result )
        return result;
      v14 = 0;
      if ( *(__int16 *)(this + 15319) > 0 )
      {
        do
        {
          result = Printf(a2, " %d", (unsigned __int8)*(this + (__int16)result + 15321));
          if ( result )
            return result;
          result = v14 + 1;
          v14 = result;
        }
        while ( (__int16)result < *(__int16 *)(this + 15319) );
      }
      result = TdrBuf::WriteChar(a2, a4);
      if ( result )
        return result;
      result = print_field(a2, a3, a4, "[farmNum]", "%d", *(__int16 *)(this + 15391));
      if ( result )
        return result;
      v11 = *(_WORD *)(this + 15391);
      if ( v11 < 0 )
        return -6;
      if ( v11 <= 70 )
      {
        result = sub_1024A3B0(a2, a3, 70, "[farm]", v11);
        if ( !result )
        {
          v15 = 0;
          if ( *(__int16 *)(this + 15391) <= 0 )
          {
LABEL_32:
            result = TdrBuf::WriteChar(a2, a4);
            if ( !result )
            {
              result = print_field(a2, a3, a4, "[supportSlot]", "0x%02x", *(this + 15463));
              if ( !result )
                return print_field(a2, a3, a4, "[battleSlot]", "0x%02x", *(this + 15464));
            }
          }
          else
          {
            while ( 1 )
            {
              result = Printf(a2, " %d", (unsigned __int8)*(this + (__int16)result + 15393));
              if ( result )
                break;
              result = v15 + 1;
              v15 = result;
              if ( (__int16)result >= *(__int16 *)(this + 15391) )
                goto LABEL_32;
            }
          }
        }
  ...
  while ( 1 )
  {
    result = sub_1024A230(a2, a3, a4, "[data]", v9);
    if ( result )
      return result;
    result = a3 >= 0 ? sub_101A5DD0(v13, a2, a3 + 1, a4) : sub_101A5DD0(v13, a2, a3, a4);
    if ( result )
      return result;
    v9 = v12 + 1;
    v13 += 1276;
