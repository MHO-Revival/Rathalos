...
// ============================================================
// Name: TLV::UnkTlv0034::DoDebugFormat
// Address Name: SUB_10128EE0
// ============================================================
//----- (10128EE0) --------------------------------------------------------
int __thiscall sub_10128EE0(const char *this, int a2, int a3, _DWORD *a4, int a5, char a6)
{
  int v8; // esi
  ...
  v11 = a3;
  v13 = 0;
  v8 = print_field(&v9, a5, a6, "[idx]", "0x%02x", *(unsigned __int8 *)this);
  if ( !v8 )
    v8 = sub_1024A410(&v9, a5, a6, "[name]", this + 1);
  if ( a4 )
    *a4 = v10;
  if ( v12 )
    sub_10C3DA30(v9);
