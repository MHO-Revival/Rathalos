...
// ============================================================
// Name: TLV::UnkTlv0229::DoDebugFormat
// Address Name: SUB_10212A40
// ============================================================
//----- (10212A40) --------------------------------------------------------
int __thiscall sub_10212A40(__int16 *this, int a2, int a3, _DWORD *a4, int a5, char a6)
{
  int v8; // esi
  ...
  v11 = a3;
  v13 = 0;
  v8 = print_field(&v9, a5, a6, "[commodity]", "%d", *this);
  if ( !v8 )
    v8 = print_field(&v9, a5, a6, "[saledCount]", "%d", *(this + 1));
  if ( a4 )
    *a4 = v10;
  if ( v12 )
    sub_10C3DA30(v9);
