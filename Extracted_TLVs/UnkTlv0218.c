// ============================================================
// Name: TLV::UnkTlv0218::Read_0xAA
// Address Name: SUB_102064D0
// ============================================================
//----- (102064D0) --------------------------------------------------------
int __thiscall sub_102064D0(int this, int a2, unsigned int a3)
{
  unsigned int v3; // eax
  _DWORD *v4; // edi
  int v6; // esi
  ...
  *(_DWORD *)(this + 61921) = 0;
  ...
  if ( v4[1] < v7 )
  {
    while ( 1 )
    {
      ...
      if ( v10 >> 4 != 2 )
        break;
      if ( (*(_BYTE *)(this + 61921) & 1) == 0 )
        *(_DWORD *)(this + 61921) |= 1u;
      a2 = 0;
...
// ============================================================
// Name: TLV::UnkTlv0218::Read_0x99
// Address Name: SUB_10206580
// ============================================================
//----- (10206580) --------------------------------------------------------
int __thiscall sub_10206580(int this, int a2, unsigned int a3)
{
  unsigned int v3; // eax
  _DWORD *v4; // edi
  int v6; // esi
...
// ============================================================
// Name: TLV::UnkTlv0218::DoDebugFormat
// Address Name: SUB_10206650
// ============================================================
//----- (10206650) --------------------------------------------------------
int __thiscall sub_10206650(char *this, signed __int32 a2, int a3, _DWORD *a4, int a5, char a6)
{
  int v7; // esi
...
// ============================================================
// Name: TLV::UnkTlv0218::DebugFormat
// Address Name: SUB_10206700
// ============================================================
//----- (10206700) --------------------------------------------------------
int __thiscall sub_10206700(char *this, _DWORD *a2, int a3, char a4)
{
  int result; // eax
  ...
  if ( !result )
  {
    result = Printf(a2, "%s%c", "[farm]", a4);
    if ( !result )
    {
      if ( a3 >= 0 )
        return sub_10205AD0(this, a2, a3 + 1, a4);
      else
        return sub_10205AD0(this, a2, a3, a4);
    }
  }
  return result;
}
