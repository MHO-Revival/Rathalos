// ============================================================
// Name: TLV::UnkTlv0274::Read
// Address Name: SUB_10231850
// ============================================================
//----- (10231850) --------------------------------------------------------
int __thiscall sub_10231850(char *this, unsigned int a2, unsigned int a3, _DWORD *a4)
{
  int result; // eax
  unsigned int v6; // esi
  char v7; // bl
  ...
  v8 = a2 - 5;
  if ( v7 == -86 )
    result = sub_10231920(this, (char *)&v9, v8);
  else
    result = sub_10231AF0(this, (char *)&v9, v8);
  if ( a4 )
    *a4 = v10;
  return result;
}
...
// ============================================================
// Name: TLV::UnkTlv0274::DoDebugFormat
// Address Name: SUB_10231CE0
// ============================================================
//----- (10231CE0) --------------------------------------------------------
int __thiscall sub_10231CE0(char *this, signed __int32 a2, int a3, _DWORD *a4, int a5, int a6)
{
  int v7; // esi
...
// ============================================================
// Name: TLV::UnkTlv0274::DebugFormat
