...
// ============================================================
// Name: TLV::UnkTlv0225::DoDebugFormat
// Address Name: SUB_1020FB20
// ============================================================
//----- (1020FB20) --------------------------------------------------------
int __thiscall sub_1020FB20(__int16 *this, int a2, int a3, _DWORD *a4, int a5, char a6)
{
  int v8; // esi
