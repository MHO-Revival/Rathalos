...
// ============================================================
// Name: TLV::UnkTlv0180::DoDebugFormat
// Address Name: SUB_101A1500
// ============================================================
//----- (101A1500) --------------------------------------------------------
int __thiscall sub_101A1500(char *this, int a2, int a3, _DWORD *a4, int a5, char a6)
{
  int v8; // esi
  ...
  if ( !v8 )
    v8 = print_field(&v9, a5, a6, "[newFlag]", "0x%02x", *(this + 4));
  if ( a4 )
    *a4 = v10;
  if ( v12 )
    sub_10C3DA30(v9);
