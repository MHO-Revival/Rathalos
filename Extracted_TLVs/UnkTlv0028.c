...
// ============================================================
// Name: TLV::UnkTlv0028::DoDebugFormat
// Address Name: SUB_10124A80
// ============================================================
//----- (10124A80) --------------------------------------------------------
int __thiscall sub_10124A80(__int16 *this, int a2, int a3, _DWORD *a4, int a5, char a6)
{
  int v8; // esi
  ...
  v11 = a3;
  v13 = 0;
  v8 = print_field(&v9, a5, a6, "[id]", "%d", *this);
  if ( !v8 )
    v8 = print_field(&v9, a5, a6, "[state]", "%d", *((unsigned __int8 *)this + 2));
  if ( a4 )
    *a4 = v10;
  if ( v12 )
    sub_10C3DA30(v9);
