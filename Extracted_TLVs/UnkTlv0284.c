...
// ============================================================
// Name: TLV::UnkTlv0284::DoDebugFormat
// Address Name: SUB_1023B2A0
// ============================================================
//----- (1023B2A0) --------------------------------------------------------
int __thiscall sub_1023B2A0(_DWORD *this, signed __int32 a2, int a3, _DWORD *a4, int a5, char a6)
{
  int v7; // esi
...
// ============================================================
// Name: TLV::UnkTlv0284::DebugFormat
