// ============================================================
// Name: TLV::UnkTlv0205::Read
// Address Name: SUB_101FA320
// ============================================================
//----- (101FA320) --------------------------------------------------------
int __thiscall sub_101FA320(_DWORD *this, unsigned int a2, unsigned int a3, _DWORD *a4)
{
  int result; // eax
  unsigned int v6; // esi
  char v7; // bl
  ...
  v8 = a2 - 5;
  if ( v7 == -86 )
    result = sub_101FA3F0(this, &v9, v8);
  else
    result = sub_101FA900(this, &v9, v8);
  if ( a4 )
    *a4 = v10;
  return result;
}
...
// ============================================================
// Name: TLV::UnkTlv0205::Read_0xAA
// Address Name: SUB_101FA3F0
// ============================================================
//----- (101FA3F0) --------------------------------------------------------
int __thiscall sub_101FA3F0(_DWORD *this, _DWORD *a2, int a3)
{
  int v4; // esi
  unsigned int v5; // eax
  int result; // eax
    ...
    while ( 1 )
    {
      ...
      switch ( v8 >> 4 )
      {
        ...
        case 0x5Bu:
          ...
          if ( !v9 )
            goto LABEL_66;
          v7 = sub_101B0400(this + 275, (int)a2, v9);
          break;
        default:
...
// ============================================================
// Name: TLV::UnkTlv0205::Read_0x99
// Address Name: SUB_101FA900
// ============================================================
//----- (101FA900) --------------------------------------------------------
int __thiscall sub_101FA900(_DWORD *this, _DWORD *a2, int a3)
{
  int v4; // esi
  unsigned int v5; // eax
  int result; // eax
    ...
    while ( 1 )
    {
      ...
      switch ( v8 >> 4 )
      {
        ...
        case 0x5Bu:
          ...
          if ( !v9 )
            goto LABEL_66;
          v7 = sub_101B0520(this + 275, (int)a2, v9);
          break;
        default:
          v7 = TdrBuf::SkipField(a2, v8 & 0xF);
          break;
...
// ============================================================
// Name: TLV::UnkTlv0205::DoDebugFormat
// Address Name: SUB_101FAE30
// ============================================================
//----- (101FAE30) --------------------------------------------------------
int __thiscall sub_101FAE30(unsigned __int8 *this, signed __int32 a2, int a3, _DWORD *a4, int a5, int a6)
{
  int v7; // esi
...
// ============================================================
// Name: TLV::UnkTlv0205::DebugFormat
// Address Name: SUB_101FAEE0
// ============================================================
//----- (101FAEE0) --------------------------------------------------------
int __thiscall sub_101FAEE0(unsigned __int8 *this, _DWORD *a2, int a3, int a4)
{
  int result; // eax
                                        ...
                                        if ( !result )
                                        {
                                          ...
                                          if ( !result )
                                          {
                                            ...
                                            if ( !result )
                                            {
                                              v14 = this + 1000;
                                              if ( a3 >= 0 )
                                                result = sub_101B0710(v14, a2, a3 + 1, a4);
                                              else
                                                result = sub_101B0710(v14, a2, a3, a4);
                                              if ( !result )
                                              {
                                                ...
                                                if ( !result )
                                                {
                                                  v15 = this + 1100;
                                                  if ( a3 >= 0 )
                                                    return sub_101B0710(v15, a2, a3 + 1, a4);
                                                  else
                                                    return sub_101B0710(v15, a2, a3, a4);
                                                }
                                              }
                                            }
                                          }
