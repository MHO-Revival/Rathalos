// ============================================================
// Name: TLV::UnkTlv0172::Read
// Address Name: SUB_1019BC10
// ============================================================
//----- (1019BC10) --------------------------------------------------------
int __thiscall sub_1019BC10(int *this, unsigned int a2, unsigned int a3, _DWORD *a4)
{
  int result; // eax
  unsigned int v6; // esi
  char v7; // bl
  ...
  v8 = a2 - 5;
  if ( v7 == -86 )
    result = sub_1019BCE0(this, &v9, v8);
  else
    result = sub_1019BD60((int)this, &v9, v8);
  if ( a4 )
    *a4 = v10;
  return result;
}
...
// ============================================================
// Name: TLV::UnkTlv0172::DoDebugFormat
// Address Name: SUB_1019BE00
// ============================================================
//----- (1019BE00) --------------------------------------------------------
int __thiscall sub_1019BE00(_DWORD *this, int a2, int a3, _DWORD *a4, int a5, char a6)
{
  int v7; // esi
  ...
  v10 = a3;
  v12 = 0;
  v7 = print_field(&v8, a5, a6, "[iEntrustUIStep]", "%d", *this);
  if ( a4 )
    *a4 = v9;
  if ( v11 )
    sub_10C3DA30(v8);
