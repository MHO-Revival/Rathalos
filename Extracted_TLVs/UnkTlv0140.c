// ============================================================
// Name: TLV::UnkTlv0140::Read
// Address Name: SUB_1017D560
// ============================================================
//----- (1017D560) --------------------------------------------------------
int __thiscall sub_1017D560(int *this, unsigned int a2, unsigned int a3, _DWORD *a4)
{
  int result; // eax
  unsigned int v6; // esi
  char v7; // bl
  ...
  v8 = a2 - 5;
  if ( v7 == -86 )
    result = sub_1017D630(this, &v9, v8);
  else
    result = sub_1017D7B0(this, &v9, v8);
  if ( a4 )
    *a4 = v10;
  return result;
}
...
// ============================================================
// Name: TLV::UnkTlv0140::DoDebugFormat
// Address Name: SUB_1017D950
// ============================================================
//----- (1017D950) --------------------------------------------------------
int __thiscall sub_1017D950(_DWORD *this, signed __int32 a2, int a3, _DWORD *a4, int a5, char a6)
{
  int v7; // esi
...
// ============================================================
// Name: TLV::UnkTlv0140::DebugFormat
