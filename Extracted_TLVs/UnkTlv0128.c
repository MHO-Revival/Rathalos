// ============================================================
// Name: TLV::UnkTlv0128::Read_0xAA
// Address Name: SUB_10175770
// ============================================================
//----- (10175770) --------------------------------------------------------
int __thiscall sub_10175770(int *this, _DWORD *a2, int a3)
{
  int v3; // eax
  int v5; // ecx
  _DWORD *v6; // edi
...
// ============================================================
// Name: TLV::UnkTlv0128::Read_0x99
// Address Name: SUB_101758C0
// ============================================================
//----- (101758C0) --------------------------------------------------------
int __thiscall sub_101758C0(_DWORD *this, _DWORD *a2, int a3)
{
  int v3; // eax
  int v5; // ecx
  _DWORD *v6; // edi
...
// ============================================================
// Name: TLV::UnkTlv0128::DoDebugFormat
// Address Name: SUB_10175A30
// ============================================================
//----- (10175A30) --------------------------------------------------------
int __thiscall sub_10175A30(int *this, signed __int32 a2, int a3, _DWORD *a4, int a5, char a6)
{
  int v7; // esi
...
// ============================================================
// Name: TLV::UnkTlv0128::DebugFormat
// Address Name: SUB_10175AE0
// ============================================================
//----- (10175AE0) --------------------------------------------------------
int __thiscall sub_10175AE0(int *this, _DWORD *a2, int a3, char a4)
{
  int result; // eax
  int v6; // ecx
  int v7; // eax
...
// 10175B3B: variable 'v6' is possibly undefined
