// ============================================================
// Name: TLV::UnkTlv0248::Read_0xAA
// Address Name: SUB_1021FC80
// ============================================================
//----- (1021FC80) --------------------------------------------------------
int __thiscall sub_1021FC80(int this, _DWORD *a2, int a3)
{
  int v4; // ecx
  unsigned int v5; // ebx
  int result; // eax
...
// ============================================================
// Name: TLV::UnkTlv0248::Read_0x99
// Address Name: SUB_1021FD70
// ============================================================
//----- (1021FD70) --------------------------------------------------------
int __thiscall sub_1021FD70(char *this, _DWORD *a2, int a3)
{
  bool v5; // cf
  int result; // eax
  int v7; // ecx
...
// ============================================================
// Name: TLV::UnkTlv0248::DoDebugFormat
// Address Name: SUB_1021FEC0
// ============================================================
//----- (1021FEC0) --------------------------------------------------------
int __thiscall sub_1021FEC0(__int16 *this, int a2, int a3, _DWORD *a4, int a5, char a6)
{
  int v8; // esi
  ...
  if ( !v8 )
    v8 = print_field(&v9, a5, a6, "[count]", "%d", *((unsigned __int8 *)this + 2));
  if ( a4 )
    *a4 = v10;
  if ( v12 )
    sub_10C3DA30(v9);
