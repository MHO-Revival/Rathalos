...
// ============================================================
// Name: TLV::UnkTlv0053::DoDebugFormat
// Address Name: SUB_1013B4D0
// ============================================================
//----- (1013B4D0) --------------------------------------------------------
int __thiscall sub_1013B4D0(_DWORD *this, int a2, int a3, _DWORD *a4, int a5, char a6)
{
  int v7; // esi
  ...
  v10 = a3;
  v12 = 0;
  v7 = print_field(&v8, a5, a6, "[itemType]", "%d", *this);
  if ( a4 )
    *a4 = v9;
  if ( v11 )
    sub_10C3DA30(v8);
