...
// ============================================================
// Name: TLV::UnkTlv0030::DoDebugFormat
// Address Name: SUB_10125A10
// ============================================================
//----- (10125A10) --------------------------------------------------------
int __thiscall sub_10125A10(__int16 *this, int a2, int a3, _DWORD *a4, int a5, char a6)
{
  int v8; // esi
