// ============================================================
// Name: TLV::UnkTlv0231::Read_0xAA
// Address Name: SUB_10213C50
// ============================================================
//----- (10213C50) --------------------------------------------------------
int __thiscall sub_10213C50(int *this, _DWORD *a2, int a3)
{
  int v3; // eax
  int *v4; // ebx
  int v5; // esi
...
LABEL_32:
      ...
      case 3u:
        if ( (v4[2634] & 4) == 0 )
          v4[2634] |= 4u;
        VarInt = TdrBuf::ReadVarUInt(v6, v4 + 2631);
        goto LABEL_30;
      case 4u:
        if ( (v4[2634] & 8) == 0 )
          v4[2634] |= 8u;
        VarInt = TdrBuf::ReadVarUInt(v6, v4 + 2632);
        goto LABEL_30;
      case 5u:
        if ( (v4[2634] & 0x10) == 0 )
          v4[2634] |= 0x10u;
        VarInt = TdrBuf::ReadVarUInt(v6, v4 + 2633);
        goto LABEL_30;
      default:
...
// ============================================================
// Name: TLV::UnkTlv0231::Read_0x99
// Address Name: SUB_10213E60
// ============================================================
//----- (10213E60) --------------------------------------------------------
int __thiscall sub_10213E60(_DWORD *this, _DWORD *a2, int a3)
{
  int v3; // eax
  _DWORD *v4; // ebx
  int v5; // esi
...
LABEL_32:
      ...
      case 3u:
        if ( (v4[2634] & 4) == 0 )
          v4[2634] |= 4u;
        Int32 = TdrBuf::ReadInt32(v6, (_BYTE *)v4 + 10524);
        goto LABEL_30;
      case 4u:
        if ( (v4[2634] & 8) == 0 )
          v4[2634] |= 8u;
        Int32 = TdrBuf::ReadInt32(v6, (_BYTE *)v4 + 10528);
        goto LABEL_30;
      case 5u:
        if ( (v4[2634] & 0x10) == 0 )
          v4[2634] |= 0x10u;
        Int32 = TdrBuf::ReadInt32(v6, (_BYTE *)v4 + 10532);
        goto LABEL_30;
      default:
...
// ============================================================
// Name: TLV::UnkTlv0231::DoDebugFormat
// Address Name: SUB_10214090
// ============================================================
//----- (10214090) --------------------------------------------------------
int __thiscall sub_10214090(int *this, signed __int32 a2, int a3, _DWORD *a4, int a5, char a6)
{
  int v7; // esi
...
// ============================================================
// Name: TLV::UnkTlv0231::DebugFormat
// Address Name: SUB_10214140
// ============================================================
//----- (10214140) --------------------------------------------------------
int __thiscall sub_10214140(int *this, _DWORD *a2, int a3, char a4)
{
  int result; // eax
  int v7; // eax
  int v8; // edi
  __int16 *v10; // [esp+1Ch] [ebp+Ch]
  ...
  if ( !result )
  {
    ...
    if ( *this >= 0 )
    {
      if ( v7 <= 20 )
      {
        ...
        {
LABEL_17:
          result = print_field(a2, a3, a4, "[refreshTimeD]", "%u", *(this + 2631));
          if ( !result )
          {
            result = print_field(a2, a3, a4, "[refreshTimeW]", "%u", *(this + 2632));
            if ( !result )
              return print_field(a2, a3, a4, "[refreshTimeM]", "%u", *(this + 2633));
          }
        }
        else
        {
          ...
          while ( 1 )
          {
            ...
            if ( result )
              break;
            result = Printf(a2, "%s[%u]%c", "[shops]", v8, a4);
            if ( result )
              break;
            result = a3 >= 0 ? sub_10213570(v10, a2, a3 + 1, a4) : sub_10213570(v10, a2, a3, a4);
            if ( result )
              break;
            ++v8;
            v10 += 263;
