...
// ============================================================
// Name: TLV::UnkTlv0266::DoDebugFormat
// Address Name: SUB_1022C230
// ============================================================
//----- (1022C230) --------------------------------------------------------
int __thiscall sub_1022C230(char *this, int a2, int a3, _DWORD *a4, int a5, char a6)
{
  int v8; // esi
  ...
  v11 = a3;
  v13 = 0;
  v8 = print_field(&v9, a5, a6, "[val]", "0x%02x", *this);
  if ( !v8 )
    v8 = print_field(&v9, a5, a6, "[hit]", "0x%02x", *(this + 1));
  if ( a4 )
    *a4 = v10;
  if ( v12 )
    sub_10C3DA30(v9);
