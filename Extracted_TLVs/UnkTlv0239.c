// ============================================================
// Name: TLV::UnkTlv0239::Read_0xAA
// Address Name: SUB_10219290
// ============================================================
//----- (10219290) --------------------------------------------------------
int __thiscall sub_10219290(int this, _DWORD *a2, int a3)
{
  int v4; // ecx
  unsigned int v5; // ebx
  int result; // eax
...
// ============================================================
// Name: TLV::UnkTlv0239::Read_0x99
// Address Name: SUB_10219330
// ============================================================
//----- (10219330) --------------------------------------------------------
int __thiscall sub_10219330(char *this, _DWORD *a2, int a3)
{
  unsigned int v4; // ebx
  bool v5; // cf
  int result; // eax
...
// ============================================================
// Name: TLV::UnkTlv0239::DoDebugFormat
// Address Name: SUB_10219450
// ============================================================
//----- (10219450) --------------------------------------------------------
int __thiscall sub_10219450(unsigned __int16 *this, int a2, int a3, _DWORD *a4, int a5, char a6)
{
  int v8; // esi
  ...
  v11 = a3;
  v13 = 0;
  v8 = print_field(&v9, a5, a6, "[cardId]", "%d", *this);
  if ( !v8 )
    v8 = print_field(&v9, a5, a6, "[finishTime]", "%u", *(_DWORD *)(this + 1));
  if ( a4 )
    *a4 = v10;
  if ( v12 )
    sub_10C3DA30(v9);
