...
// ============================================================
// Name: TLV::UnkTlv0064::DoDebugFormat
// Address Name: SUB_10143770
// ============================================================
//----- (10143770) --------------------------------------------------------
int __thiscall sub_10143770(_DWORD *this, int a2, int a3, _DWORD *a4, int a5, char a6)
{
  int v8; // esi
  ...
  v11 = a3;
  v13 = 0;
  v8 = print_field(&v9, a5, a6, "[hubId]", "%d", *this);
  if ( !v8 )
    v8 = print_field(&v9, a5, a6, "[pageIndex]", "%d", *(this + 1));
  if ( a4 )
    *a4 = v10;
  if ( v12 )
    sub_10C3DA30(v9);
