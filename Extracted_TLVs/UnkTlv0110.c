...
// ============================================================
// Name: TLV::UnkTlv0110::DoDebugFormat
// Address Name: SUB_1016A460
// ============================================================
//----- (1016A460) --------------------------------------------------------
int __thiscall sub_1016A460(unsigned __int8 *this, int a2, int a3, _DWORD *a4, int a5, char a6)
{
  int v8; // esi
  ...
  v11 = a3;
  v13 = 0;
  v8 = print_field(&v9, a5, a6, "[tipsCheck]", "0x%02x", *this);
  if ( !v8 )
    v8 = print_field(&v9, a5, a6, "[refreshTime]", "%u", *(_DWORD *)(this + 1));
  if ( a4 )
    *a4 = v10;
  if ( v12 )
    sub_10C3DA30(v9);
