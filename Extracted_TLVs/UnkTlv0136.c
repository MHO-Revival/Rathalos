// ============================================================
// Name: TLV::UnkTlv0136::Read_0xAA
// Address Name: SUB_1017AA90
// ============================================================
//----- (1017AA90) --------------------------------------------------------
int __thiscall sub_1017AA90(int *this, _DWORD *a2, int a3)
{
  int v3; // eax
  int *v4; // ebx
  int v5; // esi
...
// ============================================================
// Name: TLV::UnkTlv0136::Read_0x99
// Address Name: SUB_1017AC00
// ============================================================
//----- (1017AC00) --------------------------------------------------------
int __thiscall sub_1017AC00(_DWORD *this, _DWORD *a2, int a3)
{
  int v3; // eax
  _DWORD *v4; // ebx
  int v5; // esi
  ...
  else
  {
    while ( 1 )
    {
      ...
      else
      {
        if ( v16 >> 4 == 2 )
        {
          if ( (*(_DWORD *)((char *)v4 + 694) & 2) == 0 )
            *(_DWORD *)((char *)v4 + 694) |= 2u;
          a2 = 0;
          result = TdrBuf::ReadInt32(v6, &a2);
          if ( result )
            return result;
...
// ============================================================
// Name: TLV::UnkTlv0136::DoDebugFormat
// Address Name: SUB_1017AD90
// ============================================================
//----- (1017AD90) --------------------------------------------------------
int __thiscall sub_1017AD90(_DWORD *this, signed __int32 a2, int a3, _DWORD *a4, int a5, char a6)
{
  int v7; // esi
...
// ============================================================
// Name: TLV::UnkTlv0136::DebugFormat
// Address Name: SUB_1017AE40
// ============================================================
//----- (1017AE40) --------------------------------------------------------
int __thiscall sub_1017AE40(_DWORD *this, _DWORD *a2, int a3, char a4)
{
  int result; // eax
  int v6; // eax
  int v7; // esi
  ...
  if ( !result )
  {
    ...
    if ( (int)*this >= 0 )
    {
      if ( v6 <= 10 )
      {
        ...
        {
          for ( i = (unsigned __int8 *)(this + 1); ; i += 69 )
          {
            if ( !"[tracksSet]" )
              _wassert(
                L"NULL != variable",
            ...
            if ( result )
              break;
            result = Printf(a2, "%s[%u]%c", "[tracksSet]", v7, a4);
            if ( result )
              break;
            result = a3 >= 0 ? sub_1017A3D0(i, a2, a3 + 1, a4) : sub_1017A3D0(i, a2, a3, a4);
            if ( result )
              break;
            if ( ++v7 >= *this )
              return 0;
