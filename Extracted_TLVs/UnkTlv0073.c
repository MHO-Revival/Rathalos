// ============================================================
// Name: TLV::UnkTlv0073::Read
// Address Name: SUB_10149B20
// ============================================================
//----- (10149B20) --------------------------------------------------------
int __thiscall sub_10149B20(int *this, unsigned int a2, unsigned int a3, _DWORD *a4)
{
  int result; // eax
  unsigned int v6; // esi
  char v7; // bl
  ...
  v8 = a2 - 5;
  if ( v7 == -86 )
    result = sub_10149BF0(this, &v9, v8);
  else
    result = sub_10149D80(this, &v9, v8);
  if ( a4 )
    *a4 = v10;
  return result;
}
...
// ============================================================
// Name: TLV::UnkTlv0073::DoDebugFormat
// Address Name: SUB_10149F30
// ============================================================
//----- (10149F30) --------------------------------------------------------
int __thiscall sub_10149F30(_DWORD *this, signed __int32 a2, int a3, _DWORD *a4, int a5, char a6)
{
  int v7; // esi
...
// ============================================================
// Name: TLV::UnkTlv0073::DebugFormat
