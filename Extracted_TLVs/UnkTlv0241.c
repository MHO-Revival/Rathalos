...
// ============================================================
// Name: TLV::UnkTlv0241::DoDebugFormat
// Address Name: SUB_1021AB50
// ============================================================
//----- (1021AB50) --------------------------------------------------------
int __thiscall sub_1021AB50(unsigned __int16 *this, int a2, int a3, _DWORD *a4, int a5, char a6)
{
  int v8; // esi
  ...
  if ( !v8 )
    v8 = print_field(&v9, a5, a6, "[statValue]", "%d", *(this + 1));
  if ( a4 )
    *a4 = v10;
  if ( v12 )
    sub_10C3DA30(v9);
