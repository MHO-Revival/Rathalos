...
// ============================================================
// Name: TLV::UnkTlv0211::DoDebugFormat
// Address Name: SUB_101FFC40
// ============================================================
//----- (101FFC40) --------------------------------------------------------
int __thiscall sub_101FFC40(__int16 *this, int a2, int a3, _DWORD *a4, int a5, char a6)
{
  int v7; // esi
  ...
  v10 = a3;
  v12 = 0;
  v7 = print_field(&v8, a5, a6, "[level]", "%d", *this);
  if ( a4 )
    *a4 = v9;
  if ( v11 )
    sub_10C3DA30(v8);
