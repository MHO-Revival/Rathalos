...
// ============================================================
// Name: TLV::UnkTlv0242::DoDebugFormat
// Address Name: SUB_1021B1C0
// ============================================================
//----- (1021B1C0) --------------------------------------------------------
int __thiscall sub_1021B1C0(unsigned __int16 *this, int a2, int a3, _DWORD *a4, int a5, char a6)
{
  int v8; // esi
  ...
  v11 = a3;
  v13 = 0;
  v8 = print_field(&v9, a5, a6, "[statIdx]", "%d", *this);
  if ( !v8 )
