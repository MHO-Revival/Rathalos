...
// ============================================================
// Name: TLV::UnkTlv0268::DoDebugFormat
// Address Name: SUB_1022D390
// ============================================================
//----- (1022D390) --------------------------------------------------------
int __thiscall sub_1022D390(__int16 *this, int a2, int a3, _DWORD *a4, int a5, char a6)
{
  int v8; // esi
  ...
  if ( !v8 )
    v8 = print_field(&v9, a5, a6, "[state]", "0x%02x", *((char *)this + 2));
  if ( a4 )
    *a4 = v10;
  if ( v12 )
    sub_10C3DA30(v9);
