...
namespace Rathalos.CLI.CodeGeneration.Services
{
    ...
    public class CodeGenerationService
    {
        ...
        public async Task<(Dictionary<string, string>Classes, Dictionary<string, string> Enums)> GenerateCodeFilesAsync(GeneratedCodeModel codeModel)
        {
            ...
            {
                var constantsCode = _templateEngine.ProcessConstantsTemplate(codeModel.Constants, codeModel.TargetNamespace, codeModel.TargetName);
                generatedFiles[$"{codeModel.TargetName}Constants.cs"] = constantsCode;
            }
