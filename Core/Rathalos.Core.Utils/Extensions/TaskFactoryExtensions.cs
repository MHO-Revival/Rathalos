namespace Rathalos.Core.Utils.Extensions
{
	...
	public static class TaskFactoryExtensions
	{
		...
		{
			if (factory == null) throw new ArgumentNullException("factory");
			return factory.StartNewDelayed(millisecondsDelay, function, factory.CancellationToken, creationOptions,
								   factory.GetTargetScheduler());
		}
		...
		{
			if (factory == null) throw new ArgumentNullException("factory");
			return factory.StartNewDelayed(millisecondsDelay, function, cancellationToken, factory.CreationOptions,
								   factory.GetTargetScheduler());
		}
