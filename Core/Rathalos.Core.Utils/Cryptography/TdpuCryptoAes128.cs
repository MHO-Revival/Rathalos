///
/// TdpuCryptoAes128.cs - Implementation of TdpuCrypto using AES-128 encryption in CBC mode with TSF4G padding
...
public class TdpuCryptoAes128 : TdpuCrypto
{
    ...
    private ConnectionSecureEncodingType _tConnSecEnc;
    private byte[] _key;
    private byte[] _iv;
