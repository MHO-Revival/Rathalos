...
namespace Rathalos.Core.Protocol.Messages
{
    ...
    public class TQQAuthInfo : TPDUExtAuthData
    {
		...
		public void Serialize(IDataWriter writer)
		{
			...
			var SignDataCount = Math.Min(SignData?.Length ?? 0, TQQ_MAX_SIGN_LEN);
			...
			var Sign2DataCount = Math.Min(Sign2Data?.Length ?? 0, TQQ_MAX_SIGN2_LEN);
		...
		public void Deserialize(IDataReader reader)
		{
			...
			// Read array: SignData
			SignData = new byte[Math.Min((int)SignLen, TQQ_MAX_SIGN_LEN)];
			...
			Sign2Data = new byte[Math.Min((int)Sign2Len, TQQ_MAX_SIGN2_LEN)];
