...
namespace Rathalos.Core.Protocol.Messages.Custom.Csproto.Classes.Tlvs
{
    ...
    /// </summary>
    public class TlvBasicRoleInfo : TlvStructure
    {
            ...
            while (reader.BytesAvailable > 0)
            {
                ...
                switch (fieldId)
                {
                    ...
                    case 3:
                        ...
                        break;
                    case 4: HrLevel = reader.ReadInt(); break;
                    case 5: SvrId = reader.ReadInt(); break;
        ...
        protected override void SerializeContent(IDataWriter writer)
        {
            ...
            WriteTlvInt(writer, 4, HrLevel);
            WriteTlvInt(writer, 5, SvrId);
        }
    }
}
