...
namespace Rathalos.Core.Protocol.Messages.Csproto
{
    ...
    /// Bidding response
    /// </summary>
    public class CSAuctionBiddingRes : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_AUCTION_BIDDING_RES;
		/// <summary>
