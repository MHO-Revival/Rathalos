...
{
    /// <summary>
    /// Instance hunting mode selection
    /// </summary>
    public class CSInstanceHuntingModeReq : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_LEVEL_HUNTINGMODE_UPDATE;
		/// <summary>
		...
		/// <summary>
		/// Hunting mode 0: hunting ticket 1: contract gold
		/// </summary>
