...
namespace Rathalos.Core.Protocol.Messages.Csproto
{
    ...
    /// Daily refresh
    /// </summary>
    public class S2CRefreshxDaily : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.S2C_CMD_TASK_REFRESHXDAILY;
		/// <summary>
