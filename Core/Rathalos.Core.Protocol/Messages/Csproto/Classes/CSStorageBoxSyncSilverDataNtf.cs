...
{
    /// <summary>
    /// Silver storage box data sync - notification
    /// </summary>
    public class CSStorageBoxSyncSilverDataNtf : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.S2C_CMD_SILVERBOX_SYNC_DATA_NOTIFY;
		/// <summary>
		...
		/// Sync data
		/// </summary>
		public S2CSilverStorageBoxInfo Data { get; set; }
