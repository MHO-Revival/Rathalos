...
{
    /// <summary>
    /// Request to learn production recipe
    /// </summary>
    public class CSManufactureLearnIngredientReq : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_MANUFACTURE_LEARNINGREDIENT_REQ;
		/// <summary>
