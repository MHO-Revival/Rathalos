...
{
    /// <summary>
    /// Prepare stage finish notification
    /// </summary>
    public class CSPVPPrepareStageFinishNtf : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_PVP_PREPARE_STAGE_FINISH;
		/// <summary>
