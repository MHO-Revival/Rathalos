...
{
    /// <summary>
    /// Remove player from blacklist response
    /// </summary>
    public class CSFriendDelBlacklistRsp : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_FRIEND_DEL_BLACKLIST_RSP;
		/// <summary>
