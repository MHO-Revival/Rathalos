...
{
    /// <summary>
    /// Gift pack group state request
    /// </summary>
    public class CSGiftBagGroupStateReq : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_GIFTBAGGROUP_STATE_REQ;
		/// <summary>
