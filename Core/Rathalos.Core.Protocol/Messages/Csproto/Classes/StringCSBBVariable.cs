...
namespace Rathalos.Core.Protocol.Messages.Csproto
{
    ...
    /// String
    /// </summary>
    public class StringCSBBVariable : CSBBVariable
    {
		public const CS_BBVALUE_TYPE ProtocolIdConst = CS_BBVALUE_TYPE.CS_BBVALUE_TYPE_STRING;
		/// <summary>
		...
		{
			if (Value.Length > (CsprotoConstants.CS_MAX_BB_STRING_VALUE_LEN - 1))
			{
				throw new InvalidOperationException($"String length of 'Value' should be of length of {(CsprotoConstants.CS_MAX_BB_STRING_VALUE_LEN - 1)} but was {Value.Length}.");
			}
