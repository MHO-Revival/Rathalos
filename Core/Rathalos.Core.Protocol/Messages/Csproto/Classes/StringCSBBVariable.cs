...
namespace Rathalos.Core.Protocol.Messages.Csproto
{
    ...
    public class StringCSBBVariable : CSBBVariable
    {
		...
		{
			if (Value.Length != CsprotoConstants.CS_MAX_BB_STRING_VALUE_LEN)
			{
				throw new InvalidOperationException($"Array length of 'Value' should be of length of {CsprotoConstants.CS_MAX_BB_STRING_VALUE_LEN} but was {Value.Length}.");
			}
