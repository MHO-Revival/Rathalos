...
namespace Rathalos.Core.Protocol.Messages.Csproto
{
    ...
    /// Speak execute
    /// </summary>
    public class S2CSpeakExec : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.S2C_CMD_SPEAK_EXEC;
		/// <summary>
		...
		/// Speak execute
		/// </summary>
		public CSSpeaksExec Exec { get; set; }
