...
{
    /// <summary>
    /// Request open refine attribute
    /// </summary>
    public class CSReqEquipFoundOpen : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_ITEM_REQ_EQUIP_FOUND_OPEN;
		/// <summary>
