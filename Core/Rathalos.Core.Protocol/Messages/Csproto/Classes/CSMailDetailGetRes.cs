...
{
    public class CSMailDetailGetRes : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_MAIL_DETAILGET_RES;
		/// <summary>
		...
		public CSMailDetailGetResResult Results { get; set; }
		...
		public void Deserialize(IDataReader reader)
		{
			...
			// Selected by: Result
			Results = ProtocolTypeManager.Get<CSMailDetailGetResResult>(Result);
