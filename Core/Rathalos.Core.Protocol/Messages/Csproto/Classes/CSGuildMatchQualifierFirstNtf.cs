...
{
    /// <summary>
    /// Guild qualifier first place notify
    /// </summary>
    public class CSGuildMatchQualifierFirstNtf : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_GUILD_MATCH_QUALIFIER_FIRST_NTF;
		/// <summary>
