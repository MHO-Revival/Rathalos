...
{
    /// <summary>
    /// Silver storage box withdraw - response
    /// </summary>
    public class CSStorageBoxFetchSilverRsp : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.S2C_CMD_SILVERBOX_FETCH_RSP;
		/// <summary>
