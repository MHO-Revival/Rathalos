...
{
    /// <summary>
    /// Red yellow confrontation remove secret quest
    /// </summary>
    public class S2CActivityRemoveSecretQuest : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.S2C_CMD_ACTIVITY_REMOVESECRETQUEST;
		/// <summary>
