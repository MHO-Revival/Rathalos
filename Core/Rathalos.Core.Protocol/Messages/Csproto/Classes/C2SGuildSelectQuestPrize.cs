...
namespace Rathalos.Core.Protocol.Messages.Csproto
{
    ...
    /// Select QuestPrize
    /// </summary>
    public class C2SGuildSelectQuestPrize : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.C2S_CMD_GUILD_SELECTQUESTPRIZE;
		/// <summary>
