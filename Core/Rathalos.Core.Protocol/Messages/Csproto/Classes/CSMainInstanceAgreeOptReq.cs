...
{
    /// <summary>
    /// Instance enter agree request
    /// </summary>
    public class CSMainInstanceAgreeOptReq : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_MAIN_INSTANCE_AGREE_OPT_REQ;
		/// <summary>
