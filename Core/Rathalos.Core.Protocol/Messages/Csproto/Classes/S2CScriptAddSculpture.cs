...
namespace Rathalos.Core.Protocol.Messages.Csproto
{
    ...
    /// </summary>
    public class S2CScriptAddSculpture : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.S2C_CMD_SCRIPT_ADD_SCULPTURE;
		/// <summary>
		...
		/// Sculpture Info
		/// </summary>
		public CSSculptureInfo Sculpture { get; set; }
