...
{
    public class CSCommanderChgNtf : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_COMMANDER_CHG_NTF;
		/// <summary>
