...
namespace Rathalos.Core.Protocol.Messages.Csproto
{
    ...
    /// </summary>
    public class CSItemRebuildWakeLevelupRes : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_ITEMREBUILD_WAKE_LEVELUP_RES;
		/// <summary>
