...
{
    /// <summary>
    /// Pet delete pending skill request
    /// </summary>
    public class CSPetWaitSkillDelReq : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_PET_WAIT_SKILL_DEL_REQ;
		/// <summary>
