...
namespace Rathalos.Core.Protocol.Messages.Csproto
{
    ...
    public class S2CActivityErr : CSPkgBody
    {
		...
		public void Serialize(IDataWriter writer)
		{
			...
			if (Arg2.Length != CsprotoConstants.CS_MAX_ACTIVITY_ARGS_LEN)
			{
				throw new InvalidOperationException($"Array length of 'Arg2' should be of length of {CsprotoConstants.CS_MAX_ACTIVITY_ARGS_LEN} but was {Arg2.Length}.");
			}
