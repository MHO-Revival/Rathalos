...
{
    /// <summary>
    /// Town session established
    /// </summary>
    public class CSTownSessionStart : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_TOWN_SESSION_START;
		/// <summary>
