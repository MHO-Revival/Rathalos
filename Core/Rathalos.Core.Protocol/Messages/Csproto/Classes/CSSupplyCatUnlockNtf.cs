...
{
    /// <summary>
    /// Unlock supply cat notification
    /// </summary>
    public class CSSupplyCatUnlockNtf : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_SUPPLY_CAT_UNLOCK_NTF;
		/// <summary>
