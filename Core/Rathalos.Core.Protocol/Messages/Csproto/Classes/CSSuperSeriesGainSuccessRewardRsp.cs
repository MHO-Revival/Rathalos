...
{
    /// <summary>
    /// Super series claim success reward response
    /// </summary>
    public class CSSuperSeriesGainSuccessRewardRsp : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_SUPER_GAIN_SUCCESS_REWARD_RSP;
		/// <summary>
