...
namespace Rathalos.Core.Protocol.Messages.Csproto
{
    ...
    /// </summary>
    public class S2CFriendSvrUpdate : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.S2C_CMD_FRIEND_SVRSUPDATE;
		/// <summary>
		...
		/// Old svrid
		/// </summary>
		public uint OldSvr { get; set; }
		/// <summary>
		/// New svrid
		/// </summary>
		public uint NewSvr { get; set; }
		...
		{
			writer.WriteUInt(OldSvr);
			writer.WriteUInt(NewSvr);
		}
		...
		{
			OldSvr = reader.ReadUInt();
			NewSvr = reader.ReadUInt();
		}
