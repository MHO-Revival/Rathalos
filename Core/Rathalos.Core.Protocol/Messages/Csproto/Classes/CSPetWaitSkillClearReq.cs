...
{
    /// <summary>
    /// Pet clear pending skills request
    /// </summary>
    public class CSPetWaitSkillClearReq : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_PET_WAIT_SKILL_CLEAR_REQ;
		/// <summary>
