...
namespace Rathalos.Core.Protocol.Messages.Csproto
{
    ...
    /// Heartbeat
    /// </summary>
    public class CSHeartBeat : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_SYSTEM_HEARTBEAT;
		/// <summary>
		...
		public void Serialize(IDataWriter writer)
		{
			...
			writer.WriteLong(HeartBeatTime);
		}
