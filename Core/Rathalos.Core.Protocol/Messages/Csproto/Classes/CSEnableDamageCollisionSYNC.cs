...
{
    /// <summary>
    /// Monster damage collision sync
    /// </summary>
    public class CSEnableDamageCollisionSYNC : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_ENABLE_DAMAGECOLLISION_REQ;
		/// <summary>
