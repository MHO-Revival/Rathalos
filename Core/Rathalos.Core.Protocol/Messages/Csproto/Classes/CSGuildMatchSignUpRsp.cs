...
{
    /// <summary>
    /// Guild match signup response
    /// </summary>
    public class CSGuildMatchSignUpRsp : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_GUILD_MATCH_SIGN_UP_RSP;
		/// <summary>
