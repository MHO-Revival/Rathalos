...
{
    /// <summary>
    /// Auto start certain processes
    /// </summary>
    public class CSAutoStartProcess : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_AUTO_START_PROCESS;
		/// <summary>
		...
		/// Process type
		/// </summary>
		public CS_AUTO_START_FUNCTION ProcessType { get; set; }
		...
		{
			writer.WriteInt((int)ProcessType);
		}
		...
		{
			ProcessType = (CS_AUTO_START_FUNCTION)reader.ReadInt();
		}
