...
{
    /// <summary>
    /// Server forced state change confirmation
    /// </summary>
    public class CSServerSyncInfoAck : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_SERVER_ACTOR_FIFO_SYNC_ACK;
		/// <summary>
