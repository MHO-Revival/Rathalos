...
{
    /// <summary>
    /// Pet innate skill levelup request
    /// </summary>
    public class CSPetGiftSkillLevelupReq : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_PET_GIFT_SKILL_LEVELUP_REQ;
		/// <summary>
