...
namespace Rathalos.Core.Protocol.Messages.Csproto
{
    ...
    /// Mail error
    /// </summary>
    public class S2CMailErr : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.S2C_CMD_MAIL_ERR;
		/// <summary>
		...
		public void Serialize(IDataWriter writer)
		{
			...
			if (Arg2.Length > (CsprotoConstants.CS_MAX_MAIL_STR_LEN - 1))
			{
				throw new InvalidOperationException($"String length of 'Arg2' should be of length of {(CsprotoConstants.CS_MAX_MAIL_STR_LEN - 1)} but was {Arg2.Length}.");
			}
