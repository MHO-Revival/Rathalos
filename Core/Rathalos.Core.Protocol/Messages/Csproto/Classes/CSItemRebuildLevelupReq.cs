...
namespace Rathalos.Core.Protocol.Messages.Csproto
{
    ...
    /// Levelup request
    /// </summary>
    public class CSItemRebuildLevelupReq : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_ITEMREBUILD_LEVELUP_REQ;
		/// <summary>
		...
		/// <summary>
		/// Target level, 0 uses old logic to upgrade one tier per config
		/// </summary>
