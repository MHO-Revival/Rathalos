...
{
    /// <summary>
    /// Guild match knockout round pairing add
    /// </summary>
    public class CSGuildMatchPairAdd : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_GUILD_MATCH_PAIR_ADD;
		/// <summary>
