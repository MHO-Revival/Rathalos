...
namespace Rathalos.Core.Protocol.Messages.Csproto
{
    ...
    /// Boolean
    /// </summary>
    public class BoolCSTokenSyncVar : CSTokenSyncVar
    {
		public const CS_TOKEN_SYNC_TYPE ProtocolIdConst = CS_TOKEN_SYNC_TYPE.CS_TOKEN_SYNC_BOOL;
		/// <summary>
		...
		{
			writer.WriteShort((short)(Value ? 1 : 0));
		}
