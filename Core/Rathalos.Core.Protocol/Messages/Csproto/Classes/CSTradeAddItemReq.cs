...
{
    /// <summary>
    /// Request to add trade item
    /// </summary>
    public class CSTradeAddItemReq : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_TRADE_ADDITEM_REQ;
		/// <summary>
