...
namespace Rathalos.Core.Protocol.Messages.Csproto
{
    ...
    {
		public const EMailAccessoryType ProtocolIdConst = EMailAccessoryType.EMailAccessoryType_BindCredit;
		/// <summary>
		...
		/// Bound credits
		/// </summary>
		public uint BindCredit { get; set; }
