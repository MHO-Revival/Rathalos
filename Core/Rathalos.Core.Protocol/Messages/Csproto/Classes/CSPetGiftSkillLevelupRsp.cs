...
{
    /// <summary>
    /// Pet innate skill levelup response
    /// </summary>
    public class CSPetGiftSkillLevelupRsp : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_PET_GIFT_SKILL_LEVELUP_RSP;
		/// <summary>
