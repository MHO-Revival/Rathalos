...
{
    /// <summary>
    /// Guild match qualifier ranking list add
    /// </summary>
    public class CSGuildMatchQualifierResultAdd : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_GUILD_MATCH_QUALIFIER_RESULT_ADD;
		/// <summary>
		...
		/// Guild match ID
		/// </summary>
		public CSGuildMatchSignUpTeam MatchSignUp { get; set; }
		...
		public void Deserialize(IDataReader reader)
		{
			...
			MatchSignUp.Deserialize(reader);
		}
