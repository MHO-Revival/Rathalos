...
{
    public class CSFarmFacilityLevelupRsp : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_FARM_FACILITY_LEVELUP_RSP;
		/// <summary>
		...
		/// Facility index
		/// </summary>
		public CSFarmFacilityLevelupReq Req { get; set; }
