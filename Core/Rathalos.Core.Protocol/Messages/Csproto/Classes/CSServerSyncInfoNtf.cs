...
{
    /// <summary>
    /// Server forced state change message
    /// </summary>
    public class CSServerSyncInfoNtf : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_SERVER_ACTOR_FIFO_SYNC_NTF;
		/// <summary>
