...
{
    /// <summary>
    /// Server notify applied an effect
    /// </summary>
    public class CSApplyEffect : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_BUFF_EFFECT;
		/// <summary>
