...
namespace Rathalos.Core.Protocol.Messages.Csproto
{
    ...
    /// </summary>
    public class CSMaxCatCarCountChangeNtf : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_MAX_CAT_CAR_COUNT_CHANGE_NTF;
		/// <summary>
		...
		/// Cat cart count
		/// </summary>
		public int MaxCatCarCount { get; set; }
		...
		{
			writer.WriteInt(MaxCatCarCount);
		}
