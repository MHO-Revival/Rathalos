...
{
    /// <summary>
    /// Move friend to group response
    /// </summary>
    public class CSFriendMoveToGroupRsp : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_FRIEND_MOVE_TO_GROUP_RSP;
		/// <summary>
