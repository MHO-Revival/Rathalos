...
{
    /// <summary>
    /// Great sword power explosion request
    /// </summary>
    public class CSGiantSwordJinLiExplodeReq : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_GIANTSWORD_EXPLODE_REQ;
		/// <summary>
		...
		/// Explosion level
		/// </summary>
		public uint ExplodeLevel { get; set; }
