...
{
    /// <summary>
    /// Pet support skill levelup request
    /// </summary>
    public class CSPetSupportSkillLevelupReq : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_PET_SUPPORT_SKILL_LEVELUP_REQ;
		/// <summary>
