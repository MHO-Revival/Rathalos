...
namespace Rathalos.Core.Protocol.Messages.Csproto
{
    ...
    /// c-->s, request TS info
    /// </summary>
    public class CSLineInfoReq : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_LINEINFO_REQ;
		/// <summary>
