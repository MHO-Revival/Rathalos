...
namespace Rathalos.Core.Protocol.Messages.Csproto
{
    ...
    /// </summary>
    public class CSManufactureUpdateSkillNtf : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_MANUFACTURE_UPDATESKILL_NTF;
		/// <summary>
		...
		/// Production skill
		/// </summary>
		public ManufactureSkill Skill { get; set; }
