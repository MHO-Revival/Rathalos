...
{
    /// <summary>
    /// Actor entity position sync info
    /// </summary>
    public class CSBattleLocation : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_BATTLE_ACTOR_LOCATION;
		/// <summary>
		...
		/// </summary>
		public CSQuatT Location { get; set; }
