...
namespace Rathalos.Core.Protocol.Messages.Csproto
{
    ...
    /// Daily reset
    /// </summary>
    public class S2CResetxDaily : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.S2C_CMD_TASK_RESETXDAILY;
		/// <summary>
