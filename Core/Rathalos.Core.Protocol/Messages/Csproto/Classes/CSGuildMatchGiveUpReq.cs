...
{
    /// <summary>
    /// Guild match give up request
    /// </summary>
    public class CSGuildMatchGiveUpReq : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_GUILD_MATCH_GIVE_UP_REQ;
		/// <summary>
