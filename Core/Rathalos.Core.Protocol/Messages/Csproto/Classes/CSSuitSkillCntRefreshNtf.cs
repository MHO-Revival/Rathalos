...
{
    /// <summary>
    /// Suit skill expiration settings
    /// </summary>
    public class CSSuitSkillCntRefreshNtf : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_SUITSKILL_REFRESH_NTF;
		/// <summary>
