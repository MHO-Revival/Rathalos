...
namespace Rathalos.Core.Protocol.Messages.Csproto
{
    ...
    /// </summary>
    public class S2CSculptureLibSnapshot : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.S2C_CMD_SCULPTURE_LIB_SNAPSHOT;
		/// <summary>
		...
		/// </summary>
		public CSSculptureLib Lib { get; set; }
