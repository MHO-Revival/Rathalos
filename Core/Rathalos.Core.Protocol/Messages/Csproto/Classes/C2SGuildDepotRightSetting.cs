...
{
    /// <summary>
    /// Set depot permission
    /// </summary>
    public class C2SGuildDepotRightSetting : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.C2S_CMD_GUILD_DEPOTRIGHTSETTING;
		/// <summary>
		...
		/// </summary>
		public CSGuildTitles Rights { get; set; }
