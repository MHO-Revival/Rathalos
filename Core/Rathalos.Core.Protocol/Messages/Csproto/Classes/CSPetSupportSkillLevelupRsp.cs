...
{
    /// <summary>
    /// Pet support skill levelup response
    /// </summary>
    public class CSPetSupportSkillLevelupRsp : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_PET_SUPPORT_SKILL_LEVELUP_RSP;
		/// <summary>
