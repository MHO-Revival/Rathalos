...
namespace Rathalos.Core.Protocol.Messages.Csproto
{
    ...
    /// Feature data
    /// </summary>
    public class CSFeatureInfo : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_FEATURE_UPDATE_NOTIFY;
		/// <summary>
		...
		/// Feature CRC
		/// </summary>
		public uint FeatureHash { get; set; }
		/// <summary>
		/// Enabled features
		/// </summary>
		public ulong FeatureEnabled { get; set; }
		...
		{
			writer.WriteUInt(FeatureHash);
			writer.WriteULong(FeatureEnabled);
		}
		...
		{
			FeatureHash = reader.ReadUInt();
			FeatureEnabled = reader.ReadULong();
		}
