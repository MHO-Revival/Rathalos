...
namespace Rathalos.Core.Protocol.Messages.Csproto
{
    ...
    /// </summary>
    public class CSPlayCutSceneNtf : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_PLAY_CUTSCENE_NTF;
		/// <summary>
		...
		/// Cutscene type
		/// </summary>
		public uint CutSceneType { get; set; }
		...
		{
			writer.WriteUInt(CutSceneID);
			writer.WriteUInt(CutSceneType);
		}
		...
		{
			CutSceneID = reader.ReadUInt();
			CutSceneType = reader.ReadUInt();
		}
