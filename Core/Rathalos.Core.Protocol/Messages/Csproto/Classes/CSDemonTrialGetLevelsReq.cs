...
{
    /// <summary>
    /// Get demon trial levels
    /// </summary>
    public class CSDemonTrialGetLevelsReq : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.C2S_CMD_DEMON_TRIAL_GET_LEVELS_REQ;
		/// <summary>
