...
{
    /// <summary>
    /// Response to upgrade production skill
    /// </summary>
    public class CSManufactureLvUpSkillRsp : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_MANUFACTURE_LVUPSKILL_RSP;
		/// <summary>
