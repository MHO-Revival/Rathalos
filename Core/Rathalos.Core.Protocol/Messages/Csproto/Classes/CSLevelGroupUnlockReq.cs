...
namespace Rathalos.Core.Protocol.Messages.Csproto
{
    ...
    /// Level group unlock
    /// </summary>
    public class CSLevelGroupUnlockReq : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_PLAYER_TRY_LEVEL_GROUP_UNLOCK;
		/// <summary>
