...
{
    /// <summary>
    /// High level role delete countdown end response
    /// </summary>
    public class CSCountdownEndRsp : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_COUNTDOWN_END_RSP;
		/// <summary>
		...
		/// <summary>
		/// Remaining time until role state expires
		/// </summary>
