...
{
    /// <summary>
    /// Monster position info debug
    /// </summary>
    public class CSMonsterLocoInfoDebug : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_BATTLE_MONSTER_LOCOINFO_DEBUG;
		/// <summary>
