...
namespace Rathalos.Core.Protocol.Messages.Csproto
{
    ...
    {
		public const CS_ATTR_DATA_TYPE ProtocolIdConst = CS_ATTR_DATA_TYPE.CS_ATTR_DATA_BASE;
		/// <summary>
		...
		/// Variable value
		/// </summary>
		public CSAttrValue Value { get; set; }
		...
		public void Deserialize(IDataReader reader)
		{
			...
			// Selected by: Type
			Value = ProtocolTypeManager.Get<CSAttrValue>(Type);
