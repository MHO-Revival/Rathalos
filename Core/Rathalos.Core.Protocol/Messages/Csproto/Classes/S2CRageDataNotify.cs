...
{
    public class S2CRageDataNotify : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.S2C_CMD_RAGE_DATA_NOTIFY;
		/// <summary>
		...
		{
			writer.WriteFloat(RageValue);
			writer.WriteInt(RageSlot);
		}
		...
		{
			RageValue = reader.ReadFloat();
			RageSlot = reader.ReadInt();
		}
