...
{
    /// <summary>
    /// Red yellow confrontation request secret quest
    /// </summary>
    public class C2SActivityGetSecretQuest : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.C2S_CMD_ACTIVITY_ADDSECRETQUEST;
		/// <summary>
