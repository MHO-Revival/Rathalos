...
namespace Rathalos.Core.Protocol.Messages.Csproto
{
    ...
    /// </summary>
    public class CSClientPlayerCelebrate : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_CLIENT_PLAYER_CELEBRATE;
		/// <summary>
		...
		/// Celebration action
		/// </summary>
		public int CelebrateState { get; set; }
		...
		{
			writer.WriteInt(CelebrateState);
		}
