...
{
    public class CSExchangeRateRes : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_EXCHANGE_RATE_RES;
		/// <summary>
