...
{
    public class CSGuildWarGetCommerceBuffReq : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_GUILD_GET_COMMERCE_BUFF_REQ;
		/// <summary>
