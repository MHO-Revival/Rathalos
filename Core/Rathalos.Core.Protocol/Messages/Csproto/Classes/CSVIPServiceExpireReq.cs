...
{
    /// <summary>
    /// UI loaded query VIP service expiration request
    /// </summary>
    public class CSVIPServiceExpireReq : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_VIP_SERVICE_EXPIRE_REQ;
		/// <summary>
