...
{
    /// <summary>
    /// Guild match qualifier ranking list delete
    /// </summary>
    public class CSGuildMatchQualifierResultDel : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_GUILD_MATCH_QUALIFIER_RESULT_DEL;
		/// <summary>
