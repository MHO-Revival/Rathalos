...
{
    public class CSMailListGetRes : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_MAIL_LISTGET_RES;
		/// <summary>
		...
		public CSMailListGetResResult Results { get; set; }
		...
		public void Deserialize(IDataReader reader)
		{
			...
			// Selected by: Result
			Results = ProtocolTypeManager.Get<CSMailListGetResResult>(Result);
