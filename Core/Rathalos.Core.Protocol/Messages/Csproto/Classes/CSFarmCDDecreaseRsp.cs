...
{
    public class CSFarmCDDecreaseRsp : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_FARM_CD_DECREASR_RSP;
		/// <summary>
		...
		/// Facility index
		/// </summary>
		public CSFarmCDDecreaseReq Req { get; set; }
