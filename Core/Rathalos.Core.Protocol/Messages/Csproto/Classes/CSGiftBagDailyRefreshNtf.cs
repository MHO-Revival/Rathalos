...
{
    /// <summary>
    /// Gift pack daily refresh notification
    /// </summary>
    public class CSGiftBagDailyRefreshNtf : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_GIFTBAG_DAILYREFRESH_NTF;
		/// <summary>
