...
{
    /// <summary>
    /// Instance main UI operation sync response
    /// </summary>
    public class CSMainInstanceOptSynRsp : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_MAIN_INSTANCE_OPT_SYN_RSP;
		/// <summary>
