...
{
    public class CSGuildGetCommerceBoatStatusReq : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_GUILD_GET_COMERCE_BOAT_STATUS_REQ;
		/// <summary>
		...
		/// Player ID
		/// </summary>
		public ulong PlayerDBID { get; set; }
		/// <summary>
