...
{
    /// <summary>
    /// Super series claim challenge reward request
    /// </summary>
    public class CSSuperSeriesGainChallangeRewardReq : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_SUPER_GAIN_CHALLANGE_REWARD_REQ;
		/// <summary>
