...
{
    public class CSSurrenderResultNtf : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_SURRENDER_RESULT_NTF;
		/// <summary>
