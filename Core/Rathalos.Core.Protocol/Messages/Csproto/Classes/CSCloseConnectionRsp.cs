...
{
    /// <summary>
    /// Logically close connection response
    /// </summary>
    public class CSCloseConnectionRsp : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_CLOSE_CONNECTION_RSP;
		/// <summary>
