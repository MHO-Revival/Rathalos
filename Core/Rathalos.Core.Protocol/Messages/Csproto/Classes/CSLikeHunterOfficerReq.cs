...
{
    /// <summary>
    /// Hunter officer like request
    /// </summary>
    public class CSLikeHunterOfficerReq : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_LIKE_HUNTER_OFFICER_REQ;
		/// <summary>
