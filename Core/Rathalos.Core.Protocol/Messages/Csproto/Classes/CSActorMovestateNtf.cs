...
namespace Rathalos.Core.Protocol.Messages.Csproto
{
    ...
    /// </summary>
    public class CSActorMovestateNtf : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_BATTLE_ACTOR_MOVESTATE_NTF;
		/// <summary>
		...
		/// Timed position sync message
		/// </summary>
		public CSActorMovestate ActorMovestate { get; set; }
		...
		public void Serialize(IDataWriter writer)
		{
			...
			ActorMovestate?.Serialize(writer);
		}
		...
		public void Deserialize(IDataReader reader)
		{
			...
			ActorMovestate = new CSActorMovestate();
			ActorMovestate.Deserialize(reader);
		}
