...
{
    /// <summary>
    /// Get Felyne dig reward list
    /// </summary>
    public class CSPkgBodyExtraCatRewardResetReq : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_BATTLE_CATEXTRA_REWARD_RESET_REQ;
		/// <summary>
