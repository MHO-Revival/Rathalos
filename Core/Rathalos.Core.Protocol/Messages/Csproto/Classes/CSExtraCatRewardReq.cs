...
namespace Rathalos.Core.Protocol.Messages.Csproto
{
    ...
    /// Felyne dig request
    /// </summary>
    public class CSExtraCatRewardReq : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_BATTLE_CATEXTRA_REWARD_REQ;
		/// <summary>
