...
{
    /// <summary>
    /// Lock player FSM notification
    /// </summary>
    public class CSPkgBodyPlayerLockActionAck : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_PLAYER_LOCK_ACTION_ACK;
		/// <summary>
