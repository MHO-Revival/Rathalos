...
{
    /// <summary>
    /// Legendary skill pearl - confirm replace correction attribute - request
    /// </summary>
    public class CSLegendPearlConfirmReplaceAbilityReq : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.C2S_CMD_LEGENDPEARL_CONFIRM_REPLACE_ABILITY_REQ;
		/// <summary>
