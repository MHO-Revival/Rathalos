...
{
    /// <summary>
    /// Guild match signup confirm ready
    /// </summary>
    public class CSGuildMatchSignUpReadyNtf : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_GUILD_MATCH_SIGN_UP_READY_NTF;
		/// <summary>
