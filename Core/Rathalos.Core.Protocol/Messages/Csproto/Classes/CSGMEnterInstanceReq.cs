...
{
    /// <summary>
    /// GM enter battle instance request
    /// </summary>
    public class CSGMEnterInstanceReq : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_GM_ENTER_INSTANCE_REQ;
		/// <summary>
