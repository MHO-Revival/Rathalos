...
{
    /// <summary>
    /// Pet pending skill buy response
    /// </summary>
    public class CSPetWaitSkillBuyRsp : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_PET_WAIT_SKILL_BUY_RSP;
		/// <summary>
