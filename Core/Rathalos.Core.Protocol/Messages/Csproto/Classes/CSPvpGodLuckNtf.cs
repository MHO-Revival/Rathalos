...
namespace Rathalos.Core.Protocol.Messages.Csproto
{
    ...
    /// </summary>
    public class CSPvpGodLuckNtf : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_PVP_GOD_LUCK_NTF;
		/// <summary>
		...
		/// GODLUCK type
		/// </summary>
		public int GodLuckType { get; set; }
