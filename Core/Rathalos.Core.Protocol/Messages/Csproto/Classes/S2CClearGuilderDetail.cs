...
namespace Rathalos.Core.Protocol.Messages.Csproto
{
    ...
    /// Clear self
    /// </summary>
    public class S2CClearGuilderDetail : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.S2C_CMD_GUILD_CLEARGUILDERDETAIL;
		/// <summary>
