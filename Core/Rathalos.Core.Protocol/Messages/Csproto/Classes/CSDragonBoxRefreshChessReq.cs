...
{
    /// <summary>
    /// Request refresh dragon treasure chessboard
    /// </summary>
    public class CSDragonBoxRefreshChessReq : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_DRAGONBOX_REFRESH_CHESS_REQ;
		/// <summary>
