...
{
    public class C2SSoulBeastSetImage : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.C2S_CMD_SOULBEAST_SETIMAGE;
		/// <summary>
		...
		{
			writer.WriteInt(Beast);
			writer.WriteInt(Image);
		}
