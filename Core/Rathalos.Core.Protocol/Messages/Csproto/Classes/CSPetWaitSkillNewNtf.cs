...
{
    /// <summary>
    /// Pet pending skill new info notify
    /// </summary>
    public class CSPetWaitSkillNewNtf : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_PET_WAIT_SKILL_NEW_NTF;
		/// <summary>
