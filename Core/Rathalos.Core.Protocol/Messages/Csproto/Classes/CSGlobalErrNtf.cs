...
{
    /// <summary>
    /// Server unified error code
    /// </summary>
    public class CSGlobalErrNtf : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_SYSTEM_GLOBAL_ERROR;
		/// <summary>
