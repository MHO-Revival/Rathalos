...
namespace Rathalos.Core.Protocol.Messages.Csproto
{
    ...
    /// Shop refresh
    /// </summary>
    public class S2CRefreshShop : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.S2C_CMD_SHOP_REFRESHSHOP;
		/// <summary>
