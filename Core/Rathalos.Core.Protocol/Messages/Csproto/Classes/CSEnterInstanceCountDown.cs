...
{
    /// <summary>
    /// Enter battle instance countdown
    /// </summary>
    public class CSEnterInstanceCountDown : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_ENTER_INSTANCE_COUNT_DOWN;
		/// <summary>
