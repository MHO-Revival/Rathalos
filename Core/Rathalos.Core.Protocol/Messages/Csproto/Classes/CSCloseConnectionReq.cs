...
{
    /// <summary>
    /// Logically close connection request
    /// </summary>
    public class CSCloseConnectionReq : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_CLOSE_CONNECTION_REQ;
		/// <summary>
