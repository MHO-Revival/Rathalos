...
namespace Rathalos.Core.Protocol.Messages.Csproto
{
    ...
    public class StringCSAttrValue : CSAttrValue
    {
		...
		{
			if (Value.Length != CsprotoConstants.CS_MAX_PROP_SYNC_STRING_VALUE_LEN)
			{
				throw new InvalidOperationException($"Array length of 'Value' should be of length of {CsprotoConstants.CS_MAX_PROP_SYNC_STRING_VALUE_LEN} but was {Value.Length}.");
			}
