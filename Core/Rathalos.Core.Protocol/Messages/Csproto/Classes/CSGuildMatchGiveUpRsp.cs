...
{
    /// <summary>
    /// Guild match give up response
    /// </summary>
    public class CSGuildMatchGiveUpRsp : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_GUILD_MATCH_GIVE_UP_RSP;
		/// <summary>
