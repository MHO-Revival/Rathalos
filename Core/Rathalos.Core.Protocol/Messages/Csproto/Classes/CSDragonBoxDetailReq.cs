...
{
    /// <summary>
    /// Request dragon treasure detail info
    /// </summary>
    public class CSDragonBoxDetailReq : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_DRAGONBOX_DETAIL_REQ;
		/// <summary>
