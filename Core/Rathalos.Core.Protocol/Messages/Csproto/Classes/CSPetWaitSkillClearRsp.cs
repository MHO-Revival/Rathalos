...
{
    /// <summary>
    /// Pet clear pending skills response
    /// </summary>
    public class CSPetWaitSkillClearRsp : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_PET_WAIT_SKILL_CLEAR_RSP;
		/// <summary>
