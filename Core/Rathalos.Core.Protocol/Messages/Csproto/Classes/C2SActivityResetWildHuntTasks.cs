...
{
    /// <summary>
    /// Red yellow confrontation reset tasks
    /// </summary>
    public class C2SActivityResetWildHuntTasks : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.C2S_CMD_ACTIVITY_RESETWILDHUNTTASKS;
		/// <summary>
