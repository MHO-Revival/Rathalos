...
{
    /// <summary>
    /// Get guild invitation set
    /// </summary>
    public class S2CGetGuildInvitations : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.S2C_CMD_GUILD_GETGUILDINVITATIONS;
		/// <summary>
		...
		/// Invitation set
		/// </summary>
		public CSGuildInvitations Invitations { get; set; }
		...
		public void Deserialize(IDataReader reader)
		{
			...
			Invitations.Deserialize(reader);
		}
