...
{
    /// <summary>
    /// Pet pending skill buy request
    /// </summary>
    public class CSPetWaitSkillBuyReq : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_PET_WAIT_SKILL_BUY_REQ;
		/// <summary>
