...
{
    /// <summary>
    /// Sync player ammo change behavior response
    /// </summary>
    public class CSPlayerAmmoChangeRsp : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_PLAYER_AMMO_CHANGE_RSP;
		/// <summary>
