...
namespace Rathalos.Core.Protocol.Messages.Csproto
{
    ...
    /// Modify note
    /// </summary>
    public class C2SClanerNoteSetting : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.C2S_CMD_CLAN_CLANERNOTESETTING;
		/// <summary>
