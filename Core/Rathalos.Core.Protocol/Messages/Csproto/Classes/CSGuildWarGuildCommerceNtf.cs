...
{
    public class CSGuildWarGuildCommerceNtf : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_GUILD_COMMERCE_CHANGE_NTF;
		/// <summary>
		...
		/// Resource count
		/// </summary>
		public uint GoodNumber { get; set; }
