...
{
    /// <summary>
    /// Request to upgrade production skill
    /// </summary>
    public class CSManufactureLvUpSkillReq : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_MANUFACTURE_LVUPSKILL_REQ;
		/// <summary>
