...
namespace Rathalos.Core.Protocol.Messages.Csproto
{
    ...
    /// </summary>
    public class CSEntrustLevelGainRewardRsp : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_ENTRUST_LEVEL_GAIN_REWARD_RSP;
		/// <summary>
