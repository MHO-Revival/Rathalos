...
{
    /// <summary>
    /// Gift pack parameters notification
    /// </summary>
    public class CSGiftBagAttrNtf : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_GIFTBAG_ATTR_NTF;
		/// <summary>
