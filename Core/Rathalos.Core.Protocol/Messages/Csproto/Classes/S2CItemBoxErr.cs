...
namespace Rathalos.Core.Protocol.Messages.Csproto
{
    ...
    /// Treasure box error
    /// </summary>
    public class S2CItemBoxErr : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.S2C_CMD_ITEMBOX_ERR;
		/// <summary>
		...
		public void Serialize(IDataWriter writer)
		{
			...
			if (Arg2.Length > (CsprotoConstants.CS_MAX_ITEMBOX_STR_LEN - 1))
			{
				throw new InvalidOperationException($"String length of 'Arg2' should be of length of {(CsprotoConstants.CS_MAX_ITEMBOX_STR_LEN - 1)} but was {Arg2.Length}.");
			}
