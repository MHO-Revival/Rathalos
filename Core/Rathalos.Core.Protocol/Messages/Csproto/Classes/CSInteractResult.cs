...
namespace Rathalos.Core.Protocol.Messages.Csproto
{
    ...
    /// Interaction result
    /// </summary>
    public class CSInteractResult : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_INTERACT_RESULT;
		/// <summary>
		...
		/// Original request
		/// </summary>
		public CSInteractRequest Request { get; set; }
		/// <summary>
		/// Return code
		/// </summary>
