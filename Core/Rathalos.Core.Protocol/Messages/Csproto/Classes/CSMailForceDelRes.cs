...
{
    public class CSMailForceDelRes : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_MAIL_FORCEDEL_RES;
		/// <summary>
		...
		public CSMailForceDelResResult Results { get; set; }
		...
		public void Deserialize(IDataReader reader)
		{
			...
			// Selected by: Result
			Results = ProtocolTypeManager.Get<CSMailForceDelResResult>(Result);
