...
namespace Rathalos.Core.Protocol.Messages.Csproto
{
    ...
    /// Pet talk notify
    /// </summary>
    public class CSPetTalkNtf : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_PET_TALK_NTF;
		/// <summary>
