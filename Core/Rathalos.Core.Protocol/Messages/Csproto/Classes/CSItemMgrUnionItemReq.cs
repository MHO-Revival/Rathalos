...
namespace Rathalos.Core.Protocol.Messages.Csproto
{
    ...
    /// Request merge item
    /// </summary>
    public class CSItemMgrUnionItemReq : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_ITEMMGR_UNION_ITEM_REQ;
		/// <summary>
