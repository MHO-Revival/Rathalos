...
{
    /// <summary>
    /// Guild knockout round enter failure notify
    /// </summary>
    public class CSGuildMatchPairEnterErrNtf : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_GUILD_MATCH_PAIR_ENTER_ERR_NTF;
		/// <summary>
