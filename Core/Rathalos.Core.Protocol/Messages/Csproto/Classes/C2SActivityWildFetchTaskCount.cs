...
{
    /// <summary>
    /// Wild hunt claim extra task completion count
    /// </summary>
    public class C2SActivityWildFetchTaskCount : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.C2S_CMD_ACTIVITY_WILDHUNT_FETCHTASKCOUNT;
		/// <summary>
