...
namespace Rathalos.Core.Protocol.Messages.Csproto
{
    ...
    /// Accept task
    /// </summary>
    public class C2SAcceptTask : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.C2S_CMD_TASK_ACCEPTTASK;
		/// <summary>
		...
		/// <summary>
		/// Accept method: interactive/non-interactive
		/// </summary>
