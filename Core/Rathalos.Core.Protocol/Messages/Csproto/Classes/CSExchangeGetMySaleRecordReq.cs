...
{
    /// <summary>
    /// Query my record request
    /// </summary>
    public class CSExchangeGetMySaleRecordReq : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_EXCHANGE_GETMYSALE_RECORD_REQ;
		/// <summary>
