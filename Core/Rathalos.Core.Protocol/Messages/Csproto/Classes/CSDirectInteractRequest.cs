...
{
    /// <summary>
    /// Direct interact object request
    /// </summary>
    public class CSDirectInteractRequest : CSPkgBody
    {
		public const CS_CMD_ID ProtocolIdConst = CS_CMD_ID.CS_CMD_DIRECTINTERACT_REQUEST;
		/// <summary>
		...
		/// Player ID
		/// </summary>
		public int RequestPlayer { get; set; }
